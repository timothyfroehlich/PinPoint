...
| `_pr-gates.sh`                  | Shared bash helper sourced by `merge-pr.sh` and `merge-handoff.sh`. It evaluates the native Codex GitHub review, a CodeRabbit exact-head approval, and the existing manual marker workflow.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
