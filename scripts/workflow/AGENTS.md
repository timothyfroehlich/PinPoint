...
| `merge-pr.sh <PR> --human [-a]` | **Merge decision is Tim's — an agent may run it, the hook prompts him to approve.** Re-evaluates all 4 gates and squash-merges if all pass. `--automerge` never waits out review; the owning agent monitors the manually requested review outside this script.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| Request a Codex review after usage exhaustion  | —                                              | `request-coderabbit-review.sh <PR>`                                                                         | Request one SHA-tagged CodeRabbit review for the current head after CI passes. Refuses duplicate requests, covered or moving heads, in-progress reviews, draft/closed PRs, and non-owner auth. |
| `request-codex-review.sh <PR> <reply-ID>`      |
