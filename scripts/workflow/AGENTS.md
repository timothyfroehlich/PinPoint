...
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| `coderabbit` | Native `APPROVED` pinned to head; exact-head finding review with counted inline comments in resolved threads; or trusted incremental summary after a prior qualifying native review | `changes_requested` (its `CHANGES_REQUESTED` on head), `stale` (off-head), `none` |
