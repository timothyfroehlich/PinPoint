...
if [[ "$rv_state" != "approval" ]]; then add_block "reviewed: ${rv_state} — comment @codex review and obtain a Codex approval of the current head"; fi
