...
const testOPDBGames: OPDBTestGame[] = [
  ...
  },
  {
    ...
    description:
      "Twilight Zone is a widebody pinball machine based on the TV series The Twilight Zone.",
  },
  {
    opdbId: "G9M4Q-P1zXc",
    ...
    description:
      "Attack from Mars is a 1995 pinball machine designed by Brian Eddy and manufactured by Bally.",
  },
];
