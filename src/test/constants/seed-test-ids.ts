 ...
 * ```typescript
 * const mockContext = { organization_id: SEED_TEST_IDS.MOCK_PATTERNS.ORGANIZATION };
 * ```
 *
 * **Integration Tests**: Use direct static constants
 * ```typescript
 * const machine_id = SEED_TEST_IDS.MACHINES.MEDIEVAL_MADNESS_1;
 * const priority_id = SEED_TEST_IDS.PRIORITIES.HIGH;
 * ```
 *
 ...
 * ## Related Files
 *
 * - supabase/seeds/*.sql - Uses these IDs for seeding
 ...
 * These match the actual seeded data in supabase/seeds/*.sql
 */
export const SEED_TEST_IDS = {
  ...
  /** Test users created in supabase/seeds/03-users.sql */
  USERS: {
    /** Admin user with full permissions */
    ADMIN: "10000000-0000-4000-8000-000000000001",
    /** Standard member user */
    MEMBER1: "10000000-0000-4000-8000-000000000002",
  ...
  EMAILS: {
    ADMIN: "tim.froehlich@example.com",
    MEMBER1: "harry.williams@example.com",
    MEMBER2: "escher.lefkoff@example.com",
  },
...
// ============================================================================
// Static Mappings - Eliminates Switch Statements
// ============================================================================

/**
 * Mapping objects to replace switch statements in seed files.
 * Used by SeedMapper class for consistent ID resolution.
 */
export const STATIC_MAPPINGS = {
  /**
   * Email to membership ID mapping
   * Replaces switch statements in auth-users.ts
   */
  EMAIL_TO_MEMBERSHIP: {
    "tim.froehlich@example.com": {
      primary: SEED_TEST_IDS.MEMBERSHIPS.ADMIN_PRIMARY,
      competitor: SEED_TEST_IDS.MEMBERSHIPS.ADMIN_COMPETITOR,
    },
    "harry.williams@example.com": {
      primary: SEED_TEST_IDS.MEMBERSHIPS.MEMBER1_PRIMARY,
      competitor: SEED_TEST_IDS.MEMBERSHIPS.MEMBER1_COMPETITOR,
    },
    "escher.lefkoff@example.com": {
      primary: SEED_TEST_IDS.MEMBERSHIPS.MEMBER2_PRIMARY,
      competitor: SEED_TEST_IDS.MEMBERSHIPS.MEMBER2_COMPETITOR,
    },
  } as const,

  /**
   * Priority name to ID mapping
   * Replaces switch statements in infrastructure.ts
   */
  PRIORITY_NAMES: {
    Low: {
      primary: SEED_TEST_IDS.PRIORITIES.LOW_PRIMARY,
      competitor: SEED_TEST_IDS.PRIORITIES.LOW_COMPETITOR,
    },
    Medium: {
      primary: SEED_TEST_IDS.PRIORITIES.MEDIUM_PRIMARY,
      competitor: SEED_TEST_IDS.PRIORITIES.MEDIUM_COMPETITOR,
    },
    High: {
      primary: SEED_TEST_IDS.PRIORITIES.HIGH_PRIMARY,
      competitor: SEED_TEST_IDS.PRIORITIES.HIGH_COMPETITOR,
    },
    Critical: {
      primary: SEED_TEST_IDS.PRIORITIES.CRITICAL_PRIMARY,
      competitor: SEED_TEST_IDS.PRIORITIES.CRITICAL_COMPETITOR,
    },
  } as const,
  ...
  STATUS_NAMES: {
    New: {
      primary: SEED_TEST_IDS.STATUSES.NEW_PRIMARY,
      competitor: SEED_TEST_IDS.STATUSES.NEW_COMPETITOR,
    },
    "In Progress": {
      primary: SEED_TEST_IDS.STATUSES.IN_PROGRESS_PRIMARY,
      competitor: SEED_TEST_IDS.STATUSES.IN_PROGRESS_COMPETITOR,
    },
    "Needs Expert": {
      primary: SEED_TEST_IDS.STATUSES.NEEDS_EXPERT_PRIMARY,
      competitor: SEED_TEST_IDS.STATUSES.NEEDS_EXPERT_COMPETITOR,
    },
    "Needs Parts": {
      primary: SEED_TEST_IDS.STATUSES.NEEDS_PARTS_PRIMARY,
      competitor: SEED_TEST_IDS.STATUSES.NEEDS_PARTS_COMPETITOR,
    },
    Fixed: {
      primary: SEED_TEST_IDS.STATUSES.FIXED_PRIMARY,
      competitor: SEED_TEST_IDS.STATUSES.FIXED_COMPETITOR,
    },
    "Not to be Fixed": {
      primary: SEED_TEST_IDS.STATUSES.NOT_TO_BE_FIXED_PRIMARY,
      competitor: SEED_TEST_IDS.STATUSES.NOT_TO_BE_FIXED_COMPETITOR,
    },
    "Not Reproducible": {
      primary: SEED_TEST_IDS.STATUSES.NOT_REPRODUCIBLE_PRIMARY,
      competitor: SEED_TEST_IDS.STATUSES.NOT_REPRODUCIBLE_COMPETITOR,
    },
  } as const,

  /**
   * Role name to ID mapping
   * For consistent role ID resolution
   */
  ROLE_NAMES: {
    Admin: {
      primary: SEED_TEST_IDS.ROLES.ADMIN_PRIMARY,
      competitor: SEED_TEST_IDS.ROLES.ADMIN_COMPETITOR,
    },
    Member: {
      primary: SEED_TEST_IDS.ROLES.MEMBER_PRIMARY,
      competitor: SEED_TEST_IDS.ROLES.MEMBER_COMPETITOR,
    },
    Unauthenticated: {
      primary: SEED_TEST_IDS.ROLES.UNAUTHENTICATED_PRIMARY,
      competitor: SEED_TEST_IDS.ROLES.UNAUTHENTICATED_COMPETITOR,
    },
  } as const,

  /**
   * Collection type name to ID mapping
   * For consistent collection type ID resolution
   */
  COLLECTION_TYPE_NAMES: {
    Rooms: {
      primary: SEED_TEST_IDS.COLLECTION_TYPES.ROOMS_PRIMARY,
      competitor: SEED_TEST_IDS.COLLECTION_TYPES.ROOMS_COMPETITOR,
    },
    Manufacturer: {
      primary: SEED_TEST_IDS.COLLECTION_TYPES.MANUFACTURER_PRIMARY,
      competitor: SEED_TEST_IDS.COLLECTION_TYPES.MANUFACTURER_COMPETITOR,
    },
    Era: {
      primary: SEED_TEST_IDS.COLLECTION_TYPES.ERA_PRIMARY,
      competitor: SEED_TEST_IDS.COLLECTION_TYPES.ERA_COMPETITOR,
    },
  } as const,
} as const;
 ...
 * const machine_id = SEED_TEST_IDS.MACHINES.MEDIEVAL_MADNESS_1;
 * const location_id = SEED_TEST_IDS.LOCATIONS.MAIN_FLOOR;
...
export const createMockAdminContext = (): TestMockContext => ({
  organization_id: SEED_TEST_IDS.ORGANIZATION,
