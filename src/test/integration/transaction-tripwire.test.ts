    ...
    it("sendEmail throws when invoked inside db.transaction", async () => {
      ...
      await expect(
        db.transaction(async () => {
          ...
          // eslint-disable-next-line no-restricted-syntax -- deliberate CORE-ARCH-011 violation: this test proves the RUNTIME tripwire throws; the static rule (PP-2053.13) correctly flags it, so we suppress it here only.
