...
describe("PrimaryAppBar", () => {
  ...
  describe("Permission-based Navigation", () => {
    ...
    it("should show Games button for users with machine:view permission", () => {
      render(
        <TestWrapper userPermissions={["machine:view"]}>
          <PrimaryAppBar />
        </TestWrapper>,
      );
    ...
    it("should show both navigation buttons for admin users", () => {
      render(
        <TestWrapper userPermissions={PERMISSION_SCENARIOS.ADMIN}>
          <PrimaryAppBar />
        </TestWrapper>,
      );
    ...
    it("should show appropriate buttons for manager users", () => {
      render(
        <TestWrapper userPermissions={PERMISSION_SCENARIOS.MANAGER}>
          <PrimaryAppBar />
        </TestWrapper>,
      );
    ...
    it("should show appropriate buttons for member users", () => {
      render(
        <TestWrapper userPermissions={PERMISSION_SCENARIOS.MEMBER}>
          <PrimaryAppBar />
        </TestWrapper>,
      );
    ...
    it("should hide all navigation buttons for public users", () => {
      render(
        <TestWrapper userPermissions={PERMISSION_SCENARIOS.PUBLIC}>
          <PrimaryAppBar />
        </TestWrapper>,
      );
  ...
  describe("Integration with Permission System", () => {
    it("should properly integrate with usePermissions hook", () => {
      ...
      // The TestWrapper provides the necessary provider context
      render(
        <TestWrapper userPermissions={["issue:view", "machine:view"]}>
          <PrimaryAppBar />
        </TestWrapper>,
      );
  ...
  describe("Error Boundaries", () => {
    it("should not crash when permission hook returns undefined permissions", () => {
      ...
      render(
        <TestWrapper userPermissions={undefined as any}>
          <PrimaryAppBar />
        </TestWrapper>,
      );
