...
export default async function AdminHelpPage(): Promise<React.JSX.Element> {
  ...
  return (
    <PageContainer size="narrow">
      <Card className="border-border bg-card">
        <CardHeader>
          <CardTitle className="text-2xl">Admin Help</CardTitle>
        </CardHeader>
        <CardContent className="space-y-8">
          <section className="space-y-3">
            <h2 className="text-lg font-semibold">Username-Only Accounts</h2>
            <p className="text-sm text-muted-foreground">
              Some users prefer not to share their email address. PinPoint
              supports admin-created &ldquo;username accounts&rdquo; that use a
              username and password instead of an email.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Run the following script from the project root (requires access to
  ...
  --role member`}
            ...
            <p className="text-sm text-muted-foreground">
              ...
              username and password to the user (verbally or on paper). They log
              in by typing their username in the Email field on the login page.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Username account users cannot use &ldquo;Forgot Password&rdquo;
              since they have no email. To reset their password:
            </p>
            <pre className="bg-muted rounded-md p-4 text-sm overflow-x-auto">
              {`./scripts/admin-username-account.mjs \\
          ...
          <section className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground list-disc list-inside">
              <li>
                ...
                never receive email notifications. In-app notifications still
                work.
              </li>
              <li>
              ...
              <li>
                <strong>No invite flow</strong> — the account is created
                directly via the script, not through the invite system.
              </li>
            </ul>
          </section>
        </CardContent>
