...
/**
 * Responsive Preview — shows any route in side-by-side desktop + mobile iframes.
 *
 * Usage: /dev/preview?path=/dev/design-system
 *        /dev/preview?path=/dashboard
 *
 * Persists settings to localStorage so HMR doesn't reset your state.
 */
...
function loadState(searchParamPath: string | null): PreviewState {
  ...
  if (searchParamPath) {
    ...
    return { ...saved, path: searchParamPath };
  }
