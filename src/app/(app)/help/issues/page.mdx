...
When you report an issue, it starts as **New**. An operator confirms it's a real problem, someone picks it up and works on the repair, and eventually it's marked as **Fixed** (or closed for another reason).
...
- **Confirmed** — Verified by an operator as an actual issue
...
You automatically watch issues you create. To watch a machine, visit its page and use the watch button. You can manage your watched items from your [settings](/settings).
