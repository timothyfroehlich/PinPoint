...
/**
 * Issues Page (Protected Route - Placeholder)
 *
 * Will display list of all issues.
 */
      ...
      <Card className="w-full max-w-2xl border-outline-variant bg-surface shadow-xl">
        <CardHeader className="space-y-3 text-center">
          <div className="flex items-center justify-center gap-3">
            <AlertTriangle className="size-10 text-primary" strokeWidth={2.5} />
            <CardTitle className="text-3xl font-bold text-on-surface">
              Issues
            </CardTitle>
          </div>
          <p className="text-sm text-on-surface-variant">
            View and manage pinball machine issues
          </p>
        </CardHeader>
