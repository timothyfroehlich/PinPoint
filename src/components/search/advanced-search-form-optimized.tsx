...
import { type FilterField, type AdvancedSearchFormProps } from "./advanced-search-form";

// Lazy load heavy components for better initial bundle size
const Checkbox = dynamic(() => import("~/components/ui/checkbox").then(mod => ({ default: mod.Checkbox })), {
...
export const AdvancedSearchFormOptimized = memo(function AdvancedSearchFormOptimized({
  entityType,
  fields,
  currentParams,
  buildUrl,
