  ...
  create: organizationManageProcedure
    .input(
      z.object({
        ...
        category: z.enum([StatusCategory.NEW, StatusCategory.IN_PROGRESS, StatusCategory.RESOLVED]),
      }),
    )
  ...
  update: organizationManageProcedure
    .input(
      z.object({
        ...
        category: z.enum([StatusCategory.NEW, StatusCategory.IN_PROGRESS, StatusCategory.RESOLVED]).optional(),
      }),
    )
    .mutation(async ({ ctx, input }) => {
