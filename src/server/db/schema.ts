...
export const machines = pgTable(
  ...
  (t) => ({
    ...
    // Optimization: Index for filtering machines by unconfirmed owner (used in queries)
...
export const issues = pgTable(
  ...
  (t) => ({
    ...
    // Optimization: Index for filtering issues by unconfirmed reporter (used in reporting flow)
