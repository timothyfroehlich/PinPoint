...
- **Reviews are triggered, never automatic.** You review a PR when Tim asks you to. Copilot is likewise request-only (since 2026-08-01) — neither harness reviews on push. "Supplementing Copilot" means a second opinion on a PR under review, not a second automatic pass.
