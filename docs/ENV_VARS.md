...
| `GEMINI_API_KEY`                                                                | 🔴            | Dev/tool | `scripts/lib/gemini_worker.py`             | Google AI Studio API key for Subway worker token routing                                    |
| `GEMINI_MODEL`                                                                  | 🟢            | Dev/tool | `scripts/lib/gemini_worker.py`             | Gemini model override for Subway operations (default: `gemini-3.5-flash-lite`)              |
| `SUBWAY_MIN_LINES`                                                              | 🟢            | Dev/tool | `.claude/hooks/subway-file-size.cjs`       | Line threshold to trigger Subway file-read routing (default: 350; alias: `SHUNT_MIN_LINES`) |
