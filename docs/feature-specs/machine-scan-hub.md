...
- **3.2** **Top scores card** — the iScored Top Scores card as specified in iScored spec §4.2–§4.5: three ranked rows, "View all on iScored", and its empty and unlinked states. The hub never shows more than three scores.
