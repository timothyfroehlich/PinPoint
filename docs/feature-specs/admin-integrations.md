...
| §3.1 Discord credential-entry card                 | The standalone card has a distinct enable toggle and per-field validation                                                                  | PP-o355.51.4 and PP-o355.51.5                                                                         |
| §4 Pinball Map section                             | No Pinball Map section anywhere in admin                                                                                                   | PP-o355.51.6                                                                                          |
| §5.4–§5.7 configuration-presence state             | `location_id` is required with a default; a separate `enabled` column gates cron and reconciliation, while some readers ignore it          | PP-o355.51.4 and PP-o355.51.6                                                                         |
| §6.1 editable nullable location id                 | Location is a required DB column defaulting to 26454 plus a hardcoded `APC_LOCATION_ID`                                                    | PP-o355.51.4 and PP-o355.51.6; thread the configured id through every attribution link (CORE-PBM-001) |
