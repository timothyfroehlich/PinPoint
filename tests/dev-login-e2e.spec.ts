...
test.describe('Dev Login Authentication Flow', () => {
  ...
  test('should authenticate user and show profile button after dev login', async ({ page }) => {
  ...
  test('documents the current authentication bug', async ({ page }) => {
    ...
    await page.goto('/profile');
    await expect(page.locator('text=Error loading profile: UNAUTHORIZED')).toBeVisible();
