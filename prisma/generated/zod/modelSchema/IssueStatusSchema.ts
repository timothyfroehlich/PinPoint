...
export const IssueStatusOptionalDefaultsSchema = IssueStatusSchema.merge(z.object({
  id: z.string().cuid().optional(),
  isDefault: z.boolean().optional(),
}))

export type IssueStatusOptionalDefaults = z.infer<typeof IssueStatusOptionalDefaultsSchema>
...
export type IssueStatusWithRelations = z.infer<typeof IssueStatusSchema> & IssueStatusRelations

export const IssueStatusWithRelationsSchema: z.ZodType<IssueStatusWithRelations> = IssueStatusSchema.merge(z.object({
...
export type IssueStatusOptionalDefaultsWithRelations = z.infer<typeof IssueStatusOptionalDefaultsSchema> & IssueStatusOptionalDefaultsRelations

export const IssueStatusOptionalDefaultsWithRelationsSchema: z.ZodType<IssueStatusOptionalDefaultsWithRelations> = IssueStatusOptionalDefaultsSchema.merge(z.object({
...
export type IssueStatusPartialWithRelations = z.infer<typeof IssueStatusPartialSchema> & IssueStatusPartialRelations

export const IssueStatusPartialWithRelationsSchema: z.ZodType<IssueStatusPartialWithRelations> = IssueStatusPartialSchema.merge(z.object({
  organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
  issues: z.lazy(() => IssuePartialWithRelationsSchema).array(),
})).partial()

export type IssueStatusOptionalDefaultsWithPartialRelations = z.infer<typeof IssueStatusOptionalDefaultsSchema> & IssueStatusPartialRelations

export const IssueStatusOptionalDefaultsWithPartialRelationsSchema: z.ZodType<IssueStatusOptionalDefaultsWithPartialRelations> = IssueStatusOptionalDefaultsSchema.merge(z.object({
  organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
  issues: z.lazy(() => IssuePartialWithRelationsSchema).array(),
}).partial())

export type IssueStatusWithPartialRelations = z.infer<typeof IssueStatusSchema> & IssueStatusPartialRelations

export const IssueStatusWithPartialRelationsSchema: z.ZodType<IssueStatusWithPartialRelations> = IssueStatusSchema.merge(z.object({
  organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
  issues: z.lazy(() => IssuePartialWithRelationsSchema).array(),
}).partial())
