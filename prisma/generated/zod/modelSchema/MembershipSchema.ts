...
export type MembershipWithRelations = z.infer<typeof MembershipSchema> & MembershipRelations

export const MembershipWithRelationsSchema: z.ZodType<MembershipWithRelations> = MembershipSchema.merge(z.object({
...
export type MembershipOptionalDefaultsWithRelations = z.infer<typeof MembershipOptionalDefaultsSchema> & MembershipOptionalDefaultsRelations

export const MembershipOptionalDefaultsWithRelationsSchema: z.ZodType<MembershipOptionalDefaultsWithRelations> = MembershipOptionalDefaultsSchema.merge(z.object({
...
export type MembershipPartialWithRelations = z.infer<typeof MembershipPartialSchema> & MembershipPartialRelations

export const MembershipPartialWithRelationsSchema: z.ZodType<MembershipPartialWithRelations> = MembershipPartialSchema.merge(z.object({
  user: z.lazy(() => UserPartialWithRelationsSchema),
  organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
  role: z.lazy(() => RolePartialWithRelationsSchema),
})).partial()

export type MembershipOptionalDefaultsWithPartialRelations = z.infer<typeof MembershipOptionalDefaultsSchema> & MembershipPartialRelations

export const MembershipOptionalDefaultsWithPartialRelationsSchema: z.ZodType<MembershipOptionalDefaultsWithPartialRelations> = MembershipOptionalDefaultsSchema.merge(z.object({
  user: z.lazy(() => UserPartialWithRelationsSchema),
  organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
  role: z.lazy(() => RolePartialWithRelationsSchema),
}).partial())

export type MembershipWithPartialRelations = z.infer<typeof MembershipSchema> & MembershipPartialRelations

export const MembershipWithPartialRelationsSchema: z.ZodType<MembershipWithPartialRelations> = MembershipSchema.merge(z.object({
  user: z.lazy(() => UserPartialWithRelationsSchema),
  organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
  role: z.lazy(() => RolePartialWithRelationsSchema),
}).partial())
