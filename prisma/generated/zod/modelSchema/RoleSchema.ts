...
import {
  ...
  PermissionPartialWithRelationsSchema,
  PermissionOptionalDefaultsWithRelationsSchema,
} from "./PermissionSchema";
import type {
  PermissionWithRelations,
  PermissionPartialWithRelations,
  PermissionOptionalDefaultsWithRelations,
} from "./PermissionSchema";
...
export type RoleOptionalDefaultsWithRelations = z.infer<
  typeof RoleOptionalDefaultsSchema
> &
  RoleOptionalDefaultsRelations;

export const RoleOptionalDefaultsWithRelationsSchema: z.ZodType<RoleOptionalDefaultsWithRelations> =
  RoleOptionalDefaultsSchema.merge(
    z.object({
      organization: z.lazy(
        () => OrganizationOptionalDefaultsWithRelationsSchema,
      ),
      memberships: z
        ...
        .array(),
      permissions: z
        .lazy(() => PermissionOptionalDefaultsWithRelationsSchema)
        .array(),
    }),
  );
...
export type RolePartialWithRelations = z.infer<typeof RolePartialSchema> &
  RolePartialRelations;

export const RolePartialWithRelationsSchema: z.ZodType<RolePartialWithRelations> =
  RolePartialSchema.merge(
    z.object({
...
export type RoleOptionalDefaultsWithPartialRelations = z.infer<
  typeof RoleOptionalDefaultsSchema
> &
  RolePartialRelations;

export const RoleOptionalDefaultsWithPartialRelationsSchema: z.ZodType<RoleOptionalDefaultsWithPartialRelations> =
  RoleOptionalDefaultsSchema.merge(
    z
      .object({
        organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
...
export type RoleWithPartialRelations = z.infer<typeof RoleSchema> &
  RolePartialRelations;

export const RoleWithPartialRelationsSchema: z.ZodType<RoleWithPartialRelations> =
  RoleSchema.merge(
    z
      .object({
        organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
