...
export const IssueHistoryOptionalDefaultsSchema = IssueHistorySchema.merge(z.object({
  id: z.string().cuid().optional(),
  changedAt: z.coerce.date().optional(),
}))

export type IssueHistoryOptionalDefaults = z.infer<typeof IssueHistoryOptionalDefaultsSchema>
...
export type IssueHistoryWithRelations = z.infer<typeof IssueHistorySchema> & IssueHistoryRelations

export const IssueHistoryWithRelationsSchema: z.ZodType<IssueHistoryWithRelations> = IssueHistorySchema.merge(z.object({
...
export type IssueHistoryOptionalDefaultsWithRelations = z.infer<typeof IssueHistoryOptionalDefaultsSchema> & IssueHistoryOptionalDefaultsRelations

export const IssueHistoryOptionalDefaultsWithRelationsSchema: z.ZodType<IssueHistoryOptionalDefaultsWithRelations> = IssueHistoryOptionalDefaultsSchema.merge(z.object({
...
export type IssueHistoryPartialWithRelations = z.infer<typeof IssueHistoryPartialSchema> & IssueHistoryPartialRelations

export const IssueHistoryPartialWithRelationsSchema: z.ZodType<IssueHistoryPartialWithRelations> = IssueHistoryPartialSchema.merge(z.object({
...
export type IssueHistoryOptionalDefaultsWithPartialRelations = z.infer<typeof IssueHistoryOptionalDefaultsSchema> & IssueHistoryPartialRelations

export const IssueHistoryOptionalDefaultsWithPartialRelationsSchema: z.ZodType<IssueHistoryOptionalDefaultsWithPartialRelations> = IssueHistoryOptionalDefaultsSchema.merge(z.object({
  issue: z.lazy(() => IssuePartialWithRelationsSchema),
  organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
  actor: z.lazy(() => UserPartialWithRelationsSchema).nullable(),
}).partial())

export type IssueHistoryWithPartialRelations = z.infer<typeof IssueHistorySchema> & IssueHistoryPartialRelations

export const IssueHistoryWithPartialRelationsSchema: z.ZodType<IssueHistoryWithPartialRelations> = IssueHistorySchema.merge(z.object({
  issue: z.lazy(() => IssuePartialWithRelationsSchema),
  organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
  actor: z.lazy(() => UserPartialWithRelationsSchema).nullable(),
}).partial())
