...
import { CommentWithRelationsSchema, CommentPartialWithRelationsSchema, CommentOptionalDefaultsWithRelationsSchema } from './CommentSchema'
import type { CommentWithRelations, CommentPartialWithRelations, CommentOptionalDefaultsWithRelations } from './CommentSchema'
...
import { UpvoteWithRelationsSchema, UpvotePartialWithRelationsSchema, UpvoteOptionalDefaultsWithRelationsSchema } from './UpvoteSchema'
import type { UpvoteWithRelations, UpvotePartialWithRelations, UpvoteOptionalDefaultsWithRelations } from './UpvoteSchema'
...
export type IssueWithRelations = Omit<z.infer<typeof IssueSchema>, "checklist"> & {
...
export type IssueOptionalDefaultsWithRelations = Omit<z.infer<typeof IssueOptionalDefaultsSchema>, "checklist"> & {
  checklist?: JsonValueType | null;
} & IssueOptionalDefaultsRelations

export const IssueOptionalDefaultsWithRelationsSchema: z.ZodType<IssueOptionalDefaultsWithRelations> = IssueOptionalDefaultsSchema.merge(z.object({
  ...
  assignedTo: z.lazy(() => UserOptionalDefaultsWithRelationsSchema).nullable(),
  ...
  history: z.lazy(() => IssueHistoryOptionalDefaultsWithRelationsSchema).array(),
...
export type IssuePartialWithRelations = Omit<z.infer<typeof IssuePartialSchema>, "checklist"> & {
  checklist?: JsonValueType | null;
...
export type IssueOptionalDefaultsWithPartialRelations = Omit<z.infer<typeof IssueOptionalDefaultsSchema>, "checklist"> & {
  checklist?: JsonValueType | null;
} & IssuePartialRelations

export const IssueOptionalDefaultsWithPartialRelationsSchema: z.ZodType<IssueOptionalDefaultsWithPartialRelations> = IssueOptionalDefaultsSchema.merge(z.object({
  organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
  machine: z.lazy(() => MachinePartialWithRelationsSchema),
  priority: z.lazy(() => PriorityPartialWithRelationsSchema),
  status: z.lazy(() => IssueStatusPartialWithRelationsSchema),
...
export type IssueWithPartialRelations = Omit<z.infer<typeof IssueSchema>, "checklist"> & {
  checklist?: JsonValueType | null;
} & IssuePartialRelations
