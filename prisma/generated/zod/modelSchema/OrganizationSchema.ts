...
import {
  PinballMapConfigWithRelationsSchema,
  PinballMapConfigPartialWithRelationsSchema,
  PinballMapConfigOptionalDefaultsWithRelationsSchema,
} from "./PinballMapConfigSchema";
import type {
  PinballMapConfigWithRelations,
  PinballMapConfigPartialWithRelations,
  PinballMapConfigOptionalDefaultsWithRelations,
} from "./PinballMapConfigSchema";
...
export const OrganizationWithRelationsSchema: z.ZodType<OrganizationWithRelations> =
  OrganizationSchema.merge(
    z.object({
      ...
      pinballMapConfig: z
        .lazy(() => PinballMapConfigWithRelationsSchema)
        .nullable(),
    }),
  );
...
export const OrganizationOptionalDefaultsWithRelationsSchema: z.ZodType<OrganizationOptionalDefaultsWithRelations> =
  OrganizationOptionalDefaultsSchema.merge(
    z.object({
      ...
      priorities: z
        .lazy(() => PriorityOptionalDefaultsWithRelationsSchema)
        .array(),
      issueStatuses: z
        .lazy(() => IssueStatusOptionalDefaultsWithRelationsSchema)
        .array(),
      collectionTypes: z
        .lazy(() => CollectionTypeOptionalDefaultsWithRelationsSchema)
        .array(),
      issueHistory: z
      ...
      attachments: z
        ...
        .array(),
      pinballMapConfig: z
        .lazy(() => PinballMapConfigOptionalDefaultsWithRelationsSchema)
        .nullable(),
    }),
  );
...
export type OrganizationPartialWithRelations = z.infer<
  typeof OrganizationPartialSchema
> &
  OrganizationPartialRelations;

export const OrganizationPartialWithRelationsSchema: z.ZodType<OrganizationPartialWithRelations> =
  OrganizationPartialSchema.merge(
    z.object({
      ...
      issueStatuses: z
        .lazy(() => IssueStatusPartialWithRelationsSchema)
        .array(),
      collectionTypes: z
        .lazy(() => CollectionTypePartialWithRelationsSchema)
        .array(),
      issueHistory: z
      ...
      pinballMapConfig: z
        .lazy(() => PinballMapConfigPartialWithRelationsSchema)
        .nullable(),
    }),
  ).partial();

export type OrganizationOptionalDefaultsWithPartialRelations = z.infer<
  typeof OrganizationOptionalDefaultsSchema
> &
  OrganizationPartialRelations;

export const OrganizationOptionalDefaultsWithPartialRelationsSchema: z.ZodType<OrganizationOptionalDefaultsWithPartialRelations> =
  OrganizationOptionalDefaultsSchema.merge(
    z
      .object({
        memberships: z.lazy(() => MembershipPartialWithRelationsSchema).array(),
...
export type OrganizationWithPartialRelations = z.infer<
  typeof OrganizationSchema
> &
  OrganizationPartialRelations;

export const OrganizationWithPartialRelationsSchema: z.ZodType<OrganizationWithPartialRelations> =
  OrganizationSchema.merge(
    z
      .object({
        memberships: z.lazy(() => MembershipPartialWithRelationsSchema).array(),
