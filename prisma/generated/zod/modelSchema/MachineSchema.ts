...
import { ModelWithRelationsSchema, ModelPartialWithRelationsSchema, ModelOptionalDefaultsWithRelationsSchema } from './ModelSchema'
import type { ModelWithRelations, ModelPartialWithRelations, ModelOptionalDefaultsWithRelations } from './ModelSchema'
...
export const MachineOptionalDefaultsSchema = MachineSchema.merge(z.object({
...
export type MachineOptionalDefaults = z.infer<typeof MachineOptionalDefaultsSchema>
...
export type MachineWithRelations = z.infer<typeof MachineSchema> & MachineRelations

export const MachineWithRelationsSchema: z.ZodType<MachineWithRelations> = MachineSchema.merge(z.object({
...
export type MachineOptionalDefaultsWithRelations = z.infer<typeof MachineOptionalDefaultsSchema> & MachineOptionalDefaultsRelations

export const MachineOptionalDefaultsWithRelationsSchema: z.ZodType<MachineOptionalDefaultsWithRelations> = MachineOptionalDefaultsSchema.merge(z.object({
...
export type MachinePartialWithRelations = z.infer<typeof MachinePartialSchema> & MachinePartialRelations

export const MachinePartialWithRelationsSchema: z.ZodType<MachinePartialWithRelations> = MachinePartialSchema.merge(z.object({
...
export type MachineOptionalDefaultsWithPartialRelations = z.infer<typeof MachineOptionalDefaultsSchema> & MachinePartialRelations

export const MachineOptionalDefaultsWithPartialRelationsSchema: z.ZodType<MachineOptionalDefaultsWithPartialRelations> = MachineOptionalDefaultsSchema.merge(z.object({
  organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
  location: z.lazy(() => LocationPartialWithRelationsSchema),
  model: z.lazy(() => ModelPartialWithRelationsSchema),
  owner: z.lazy(() => UserPartialWithRelationsSchema).nullable(),
...
export type MachineWithPartialRelations = z.infer<typeof MachineSchema> & MachinePartialRelations

export const MachineWithPartialRelationsSchema: z.ZodType<MachineWithPartialRelations> = MachineSchema.merge(z.object({
  organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
  location: z.lazy(() => LocationPartialWithRelationsSchema),
  model: z.lazy(() => ModelPartialWithRelationsSchema),
  owner: z.lazy(() => UserPartialWithRelationsSchema).nullable(),
