...
import { AccountWithRelationsSchema, AccountPartialWithRelationsSchema, AccountOptionalDefaultsWithRelationsSchema } from './AccountSchema'
import type { AccountWithRelations, AccountPartialWithRelations, AccountOptionalDefaultsWithRelations } from './AccountSchema'
...
export const UserOptionalDefaultsWithRelationsSchema: z.ZodType<UserOptionalDefaultsWithRelations> = UserOptionalDefaultsSchema.merge(z.object({
  ...
  ownedMachines: z.lazy(() => MachineOptionalDefaultsWithRelationsSchema).array(),
  issuesCreated: z.lazy(() => IssueOptionalDefaultsWithRelationsSchema).array(),
  issuesAssigned: z.lazy(() => IssueOptionalDefaultsWithRelationsSchema).array(),
  comments: z.lazy(() => CommentOptionalDefaultsWithRelationsSchema).array(),
  deletedComments: z.lazy(() => CommentOptionalDefaultsWithRelationsSchema).array(),
  upvotes: z.lazy(() => UpvoteOptionalDefaultsWithRelationsSchema).array(),
  activityHistory: z.lazy(() => IssueHistoryOptionalDefaultsWithRelationsSchema).array(),
...
export const UserPartialWithRelationsSchema: z.ZodType<UserPartialWithRelations> = UserPartialSchema.merge(z.object({
  ...
  activityHistory: z.lazy(() => IssueHistoryPartialWithRelationsSchema).array(),
