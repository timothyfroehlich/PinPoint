...
export const CollectionTypeOptionalDefaultsSchema = CollectionTypeSchema.merge(z.object({
...
export type CollectionTypeOptionalDefaults = z.infer<typeof CollectionTypeOptionalDefaultsSchema>
...
export type CollectionTypeWithRelations = Omit<z.infer<typeof CollectionTypeSchema>, "generationRules"> & {
  generationRules?: JsonValueType | null;
} & CollectionTypeRelations

export const CollectionTypeWithRelationsSchema: z.ZodType<CollectionTypeWithRelations> = CollectionTypeSchema.merge(z.object({
...
export type CollectionTypeOptionalDefaultsWithRelations = Omit<z.infer<typeof CollectionTypeOptionalDefaultsSchema>, "generationRules"> & {
  generationRules?: JsonValueType | null;
} & CollectionTypeOptionalDefaultsRelations

export const CollectionTypeOptionalDefaultsWithRelationsSchema: z.ZodType<CollectionTypeOptionalDefaultsWithRelations> = CollectionTypeOptionalDefaultsSchema.merge(z.object({
...
export type CollectionTypePartialWithRelations = Omit<z.infer<typeof CollectionTypePartialSchema>, "generationRules"> & {
  generationRules?: JsonValueType | null;
} & CollectionTypePartialRelations

export const CollectionTypePartialWithRelationsSchema: z.ZodType<CollectionTypePartialWithRelations> = CollectionTypePartialSchema.merge(z.object({
  organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
  collections: z.lazy(() => CollectionPartialWithRelationsSchema).array(),
})).partial()

export type CollectionTypeOptionalDefaultsWithPartialRelations = Omit<z.infer<typeof CollectionTypeOptionalDefaultsSchema>, "generationRules"> & {
  generationRules?: JsonValueType | null;
} & CollectionTypePartialRelations

export const CollectionTypeOptionalDefaultsWithPartialRelationsSchema: z.ZodType<CollectionTypeOptionalDefaultsWithPartialRelations> = CollectionTypeOptionalDefaultsSchema.merge(z.object({
  organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
  collections: z.lazy(() => CollectionPartialWithRelationsSchema).array(),
}).partial())

export type CollectionTypeWithPartialRelations = Omit<z.infer<typeof CollectionTypeSchema>, "generationRules"> & {
  generationRules?: JsonValueType | null;
} & CollectionTypePartialRelations

export const CollectionTypeWithPartialRelationsSchema: z.ZodType<CollectionTypeWithPartialRelations> = CollectionTypeSchema.merge(z.object({
  organization: z.lazy(() => OrganizationPartialWithRelationsSchema),
  collections: z.lazy(() => CollectionPartialWithRelationsSchema).array(),
}).partial())
