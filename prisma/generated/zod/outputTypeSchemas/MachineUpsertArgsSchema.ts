...
export const MachineUpsertArgsSchema: z.ZodType<Prisma.MachineUpsertArgs> = z
  .object({
    select: MachineSelectSchema.optional(),
    include: z.lazy(() => MachineIncludeSchema).optional(),
    where: MachineWhereUniqueInputSchema,
    create: z.union([
      MachineCreateInputSchema,
      MachineUncheckedCreateInputSchema,
    ]),
    update: z.union([
      MachineUpdateInputSchema,
      MachineUncheckedUpdateInputSchema,
    ]),
  })
  .strict() as z.ZodType<Prisma.MachineUpsertArgs>;
