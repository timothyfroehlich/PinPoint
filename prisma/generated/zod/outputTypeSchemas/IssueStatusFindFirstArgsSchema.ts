...
export const IssueStatusFindFirstArgsSchema: z.ZodType<Prisma.IssueStatusFindFirstArgs> = z.object({
  ...
  distinct: z.union([ IssueStatusScalarFieldEnumSchema,IssueStatusScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default IssueStatusFindFirstArgsSchema;
