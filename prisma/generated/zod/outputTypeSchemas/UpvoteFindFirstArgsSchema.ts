...
export const UpvoteFindFirstArgsSchema: z.ZodType<Prisma.UpvoteFindFirstArgs> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.UpvoteFindFirstArgs>;

export default UpvoteFindFirstArgsSchema;
