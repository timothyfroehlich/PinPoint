...
export const PinballMapConfigUpdateManyArgsSchema: z.ZodType<Prisma.PinballMapConfigUpdateManyArgs> =
  z
    .object({
      data: z.union([
    ...
    .strict() as z.ZodType<Prisma.PinballMapConfigUpdateManyArgs>;
