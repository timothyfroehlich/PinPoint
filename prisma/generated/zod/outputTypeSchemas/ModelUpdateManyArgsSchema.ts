...
export const ModelUpdateManyArgsSchema: z.ZodType<Prisma.ModelUpdateManyArgs> =
  z
    .object({
      data: z.union([
    ...
    .strict() as z.ZodType<Prisma.ModelUpdateManyArgs>;

export default ModelUpdateManyArgsSchema;
