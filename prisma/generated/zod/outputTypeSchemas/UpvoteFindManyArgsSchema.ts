...
export const UpvoteFindManyArgsSchema: z.ZodType<Prisma.UpvoteFindManyArgs> = z
  .object({
    ...
    distinct: z
      .union([UpvoteScalarFieldEnumSchema, UpvoteScalarFieldEnumSchema.array()])
      .optional(),
  })
  .strict() as z.ZodType<Prisma.UpvoteFindManyArgs>;
