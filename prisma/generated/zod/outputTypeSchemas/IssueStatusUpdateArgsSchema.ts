...
export const IssueStatusUpdateArgsSchema: z.ZodType<Prisma.IssueStatusUpdateArgs> = z.object({
  select: IssueStatusSelectSchema.optional(),
  include: z.lazy(() => IssueStatusIncludeSchema).optional(),
  data: z.union([ IssueStatusUpdateInputSchema,IssueStatusUncheckedUpdateInputSchema ]),
  where: IssueStatusWhereUniqueInputSchema,
}).strict() ;

export default IssueStatusUpdateArgsSchema;
