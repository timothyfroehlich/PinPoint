...
export const UpvoteUpsertArgsSchema: z.ZodType<Prisma.UpvoteUpsertArgs> = z
  .object({
    select: UpvoteSelectSchema.optional(),
    include: z.lazy(() => UpvoteIncludeSchema).optional(),
    where: UpvoteWhereUniqueInputSchema,
    create: z.union([
      UpvoteCreateInputSchema,
      UpvoteUncheckedCreateInputSchema,
    ]),
    update: z.union([
      UpvoteUpdateInputSchema,
      UpvoteUncheckedUpdateInputSchema,
    ]),
  })
  .strict() as z.ZodType<Prisma.UpvoteUpsertArgs>;
