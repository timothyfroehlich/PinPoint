...
export const CollectionTypeCreateArgsSchema: z.ZodType<Prisma.CollectionTypeCreateArgs> = z.object({
  select: CollectionTypeSelectSchema.optional(),
  include: z.lazy(() => CollectionTypeIncludeSchema).optional(),
  data: z.union([ CollectionTypeCreateInputSchema,CollectionTypeUncheckedCreateInputSchema ]),
}).strict() ;
