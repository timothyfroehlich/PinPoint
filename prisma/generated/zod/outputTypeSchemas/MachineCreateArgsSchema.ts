...
export const MachineCreateArgsSchema: z.ZodType<Prisma.MachineCreateArgs> = z
  .object({
  ...
  .strict() as z.ZodType<Prisma.MachineCreateArgs>;

export default MachineCreateArgsSchema;
