...
export const ModelGroupByArgsSchema: z.ZodType<Prisma.ModelGroupByArgs> = z
  .object({
    where: ModelWhereInputSchema.optional(),
    orderBy: z
      .union([
        ModelOrderByWithAggregationInputSchema.array(),
        ModelOrderByWithAggregationInputSchema,
      ])
      .optional(),
  ...
  .strict() as z.ZodType<Prisma.ModelGroupByArgs>;
