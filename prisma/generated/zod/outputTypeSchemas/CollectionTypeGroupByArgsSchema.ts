...
export const CollectionTypeGroupByArgsSchema: z.ZodType<Prisma.CollectionTypeGroupByArgs> = z.object({
  where: CollectionTypeWhereInputSchema.optional(),
  orderBy: z.union([ CollectionTypeOrderByWithAggregationInputSchema.array(),CollectionTypeOrderByWithAggregationInputSchema ]).optional(),
