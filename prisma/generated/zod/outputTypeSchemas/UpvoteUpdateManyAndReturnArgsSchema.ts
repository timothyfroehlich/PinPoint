...
export const UpvoteUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.UpvoteUpdateManyAndReturnArgs> =
  z
    .object({
      data: z.union([
        UpvoteUpdateManyMutationInputSchema,
        UpvoteUncheckedUpdateManyInputSchema,
      ]),
      where: UpvoteWhereInputSchema.optional(),
      limit: z.number().optional(),
    })
    .strict() as z.ZodType<Prisma.UpvoteUpdateManyAndReturnArgs>;
