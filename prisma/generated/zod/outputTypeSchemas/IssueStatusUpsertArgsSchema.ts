...
import { IssueStatusUpdateInputSchema } from '../inputTypeSchemas/IssueStatusUpdateInputSchema'
import { IssueStatusUncheckedUpdateInputSchema } from '../inputTypeSchemas/IssueStatusUncheckedUpdateInputSchema'
...
export const IssueStatusUpsertArgsSchema: z.ZodType<Prisma.IssueStatusUpsertArgs> = z.object({
  ...
  create: z.union([ IssueStatusCreateInputSchema,IssueStatusUncheckedCreateInputSchema ]),
  update: z.union([ IssueStatusUpdateInputSchema,IssueStatusUncheckedUpdateInputSchema ]),
}).strict() ;

export default IssueStatusUpsertArgsSchema;
