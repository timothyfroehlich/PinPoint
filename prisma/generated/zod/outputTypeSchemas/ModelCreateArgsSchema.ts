...
import { ModelCreateInputSchema } from "../inputTypeSchemas/ModelCreateInputSchema";
import { ModelUncheckedCreateInputSchema } from "../inputTypeSchemas/ModelUncheckedCreateInputSchema";
...
export const ModelCreateArgsSchema: z.ZodType<Prisma.ModelCreateArgs> = z
  .object({
  ...
  .strict() as z.ZodType<Prisma.ModelCreateArgs>;

export default ModelCreateArgsSchema;
