...
export const IssueHistoryUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.IssueHistoryUpdateManyAndReturnArgs> =
  z
    .object({
      data: z.union([
        IssueHistoryUpdateManyMutationInputSchema,
        IssueHistoryUncheckedUpdateManyInputSchema,
      ]),
      where: IssueHistoryWhereInputSchema.optional(),
      limit: z.number().optional(),
    })
    .strict() as z.ZodType<Prisma.IssueHistoryUpdateManyAndReturnArgs>;
