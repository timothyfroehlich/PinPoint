...
export const PinballMapConfigCreateArgsSchema: z.ZodType<Prisma.PinballMapConfigCreateArgs> = z.object({
  select: PinballMapConfigSelectSchema.optional(),
  include: z.lazy(() => PinballMapConfigIncludeSchema).optional(),
  data: z.union([ PinballMapConfigCreateInputSchema,PinballMapConfigUncheckedCreateInputSchema ]),
}).strict() ;
