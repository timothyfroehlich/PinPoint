...
export const MachineFindManyArgsSchema: z.ZodType<Prisma.MachineFindManyArgs> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.MachineFindManyArgs>;

export default MachineFindManyArgsSchema;
