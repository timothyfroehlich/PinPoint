...
export const PinballMapConfigGroupByArgsSchema: z.ZodType<Prisma.PinballMapConfigGroupByArgs> =
  z
    .object({
      where: PinballMapConfigWhereInputSchema.optional(),
      orderBy: z
        .union([
          PinballMapConfigOrderByWithAggregationInputSchema.array(),
          PinballMapConfigOrderByWithAggregationInputSchema,
        ])
        .optional(),
    ...
    .strict() as z.ZodType<Prisma.PinballMapConfigGroupByArgs>;
