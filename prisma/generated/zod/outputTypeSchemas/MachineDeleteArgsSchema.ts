...
export const MachineDeleteArgsSchema: z.ZodType<Prisma.MachineDeleteArgs> = z
  .object({
    select: MachineSelectSchema.optional(),
    include: z.lazy(() => MachineIncludeSchema).optional(),
    where: MachineWhereUniqueInputSchema,
  })
  .strict() as z.ZodType<Prisma.MachineDeleteArgs>;

export default MachineDeleteArgsSchema;
