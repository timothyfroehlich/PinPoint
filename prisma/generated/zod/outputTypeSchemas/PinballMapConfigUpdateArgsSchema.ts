...
export const PinballMapConfigUpdateArgsSchema: z.ZodType<Prisma.PinballMapConfigUpdateArgs> = z.object({
  select: PinballMapConfigSelectSchema.optional(),
  include: z.lazy(() => PinballMapConfigIncludeSchema).optional(),
  data: z.union([ PinballMapConfigUpdateInputSchema,PinballMapConfigUncheckedUpdateInputSchema ]),
