...
export const IssueHistoryFindManyArgsSchema: z.ZodType<Prisma.IssueHistoryFindManyArgs> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.IssueHistoryFindManyArgs>;

export default IssueHistoryFindManyArgsSchema;
