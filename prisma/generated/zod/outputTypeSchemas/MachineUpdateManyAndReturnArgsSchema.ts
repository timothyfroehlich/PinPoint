...
export const MachineUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.MachineUpdateManyAndReturnArgs> =
  z
    .object({
      data: z.union([
    ...
    .strict() as z.ZodType<Prisma.MachineUpdateManyAndReturnArgs>;
