...
export const PriorityUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.PriorityUpdateManyAndReturnArgs> =
  z
    .object({
      data: z.union([
    ...
    .strict() as z.ZodType<Prisma.PriorityUpdateManyAndReturnArgs>;
