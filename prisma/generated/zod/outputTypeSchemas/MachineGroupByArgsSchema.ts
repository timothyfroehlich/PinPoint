...
export const MachineGroupByArgsSchema: z.ZodType<Prisma.MachineGroupByArgs> = z
  .object({
    where: MachineWhereInputSchema.optional(),
    orderBy: z
      .union([
        MachineOrderByWithAggregationInputSchema.array(),
        MachineOrderByWithAggregationInputSchema,
      ])
      .optional(),
  ...
  .strict() as z.ZodType<Prisma.MachineGroupByArgs>;
