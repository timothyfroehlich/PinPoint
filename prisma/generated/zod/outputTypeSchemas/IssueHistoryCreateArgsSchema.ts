...
export const IssueHistoryCreateArgsSchema: z.ZodType<Prisma.IssueHistoryCreateArgs> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.IssueHistoryCreateArgs>;

export default IssueHistoryCreateArgsSchema;
