...
export const IssueHistoryGroupByArgsSchema: z.ZodType<Prisma.IssueHistoryGroupByArgs> =
  z
    .object({
      where: IssueHistoryWhereInputSchema.optional(),
      orderBy: z
        .union([
          IssueHistoryOrderByWithAggregationInputSchema.array(),
          IssueHistoryOrderByWithAggregationInputSchema,
        ])
        .optional(),
    ...
    .strict() as z.ZodType<Prisma.IssueHistoryGroupByArgs>;
