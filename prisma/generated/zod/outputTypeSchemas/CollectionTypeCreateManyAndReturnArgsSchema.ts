...
export const CollectionTypeCreateManyAndReturnArgsSchema: z.ZodType<Prisma.CollectionTypeCreateManyAndReturnArgs> =
  z
    .object({
      data: z.union([
    ...
    .strict() as z.ZodType<Prisma.CollectionTypeCreateManyAndReturnArgs>;
