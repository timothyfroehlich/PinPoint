...
export const PinballMapConfigFindFirstOrThrowArgsSchema: z.ZodType<Prisma.PinballMapConfigFindFirstOrThrowArgs> =
  z
    .object({
      ...
      distinct: z
        .union([
          PinballMapConfigScalarFieldEnumSchema,
          PinballMapConfigScalarFieldEnumSchema.array(),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.PinballMapConfigFindFirstOrThrowArgs>;

export default PinballMapConfigFindFirstOrThrowArgsSchema;
