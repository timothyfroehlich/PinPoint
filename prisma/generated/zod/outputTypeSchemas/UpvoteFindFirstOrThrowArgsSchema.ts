...
export const UpvoteFindFirstOrThrowArgsSchema: z.ZodType<Prisma.UpvoteFindFirstOrThrowArgs> =
  z
    .object({
      ...
      distinct: z
        .union([
          UpvoteScalarFieldEnumSchema,
          UpvoteScalarFieldEnumSchema.array(),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.UpvoteFindFirstOrThrowArgs>;

export default UpvoteFindFirstOrThrowArgsSchema;
