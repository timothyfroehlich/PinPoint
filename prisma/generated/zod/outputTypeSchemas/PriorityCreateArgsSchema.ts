...
export const PriorityCreateArgsSchema: z.ZodType<Prisma.PriorityCreateArgs> = z
  .object({
    select: PrioritySelectSchema.optional(),
    include: z.lazy(() => PriorityIncludeSchema).optional(),
    data: z.union([
      PriorityCreateInputSchema,
      PriorityUncheckedCreateInputSchema,
    ]),
  })
  .strict() as z.ZodType<Prisma.PriorityCreateArgs>;
