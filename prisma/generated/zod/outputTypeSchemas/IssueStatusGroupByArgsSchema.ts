...
export const IssueStatusGroupByArgsSchema: z.ZodType<Prisma.IssueStatusGroupByArgs> = z.object({
  where: IssueStatusWhereInputSchema.optional(),
  orderBy: z.union([ IssueStatusOrderByWithAggregationInputSchema.array(),IssueStatusOrderByWithAggregationInputSchema ]).optional(),
