...
export const MachineFindFirstArgsSchema: z.ZodType<Prisma.MachineFindFirstArgs> =
  z
    .object({
      ...
      orderBy: z
        .union([
          MachineOrderByWithRelationInputSchema.array(),
          MachineOrderByWithRelationInputSchema,
        ])
        .optional(),
      ...
      distinct: z
        .union([
          MachineScalarFieldEnumSchema,
          MachineScalarFieldEnumSchema.array(),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.MachineFindFirstArgs>;

export default MachineFindFirstArgsSchema;
