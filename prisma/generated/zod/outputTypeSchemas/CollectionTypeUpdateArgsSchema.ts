...
export const CollectionTypeUpdateArgsSchema: z.ZodType<Prisma.CollectionTypeUpdateArgs> = z.object({
  select: CollectionTypeSelectSchema.optional(),
  include: z.lazy(() => CollectionTypeIncludeSchema).optional(),
  data: z.union([ CollectionTypeUpdateInputSchema,CollectionTypeUncheckedUpdateInputSchema ]),
  where: CollectionTypeWhereUniqueInputSchema,
}).strict() ;

export default CollectionTypeUpdateArgsSchema;
