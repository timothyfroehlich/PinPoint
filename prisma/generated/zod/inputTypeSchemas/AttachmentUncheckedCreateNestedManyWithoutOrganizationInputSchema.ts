...
export const AttachmentUncheckedCreateNestedManyWithoutOrganizationInputSchema: z.ZodType<Prisma.AttachmentUncheckedCreateNestedManyWithoutOrganizationInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.AttachmentUncheckedCreateNestedManyWithoutOrganizationInput>;
