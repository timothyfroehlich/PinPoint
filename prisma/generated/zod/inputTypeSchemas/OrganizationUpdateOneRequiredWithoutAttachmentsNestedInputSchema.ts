...
export const OrganizationUpdateOneRequiredWithoutAttachmentsNestedInputSchema: z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutAttachmentsNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => OrganizationCreateWithoutAttachmentsInputSchema),
          z.lazy(
            () => OrganizationUncheckedCreateWithoutAttachmentsInputSchema,
          ),
        ])
        .optional(),
      connectOrCreate: z
        .lazy(() => OrganizationCreateOrConnectWithoutAttachmentsInputSchema)
        .optional(),
      upsert: z
        .lazy(() => OrganizationUpsertWithoutAttachmentsInputSchema)
        .optional(),
      connect: z.lazy(() => OrganizationWhereUniqueInputSchema).optional(),
      update: z
        .union([
          z.lazy(
            () => OrganizationUpdateToOneWithWhereWithoutAttachmentsInputSchema,
          ),
          z.lazy(() => OrganizationUpdateWithoutAttachmentsInputSchema),
          z.lazy(
            () => OrganizationUncheckedUpdateWithoutAttachmentsInputSchema,
          ),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutAttachmentsNestedInput>;
