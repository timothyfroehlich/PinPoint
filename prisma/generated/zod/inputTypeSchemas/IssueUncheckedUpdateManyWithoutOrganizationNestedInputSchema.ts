...
export const IssueUncheckedUpdateManyWithoutOrganizationNestedInputSchema: z.ZodType<Prisma.IssueUncheckedUpdateManyWithoutOrganizationNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => IssueUpsertWithWhereUniqueWithoutOrganizationInputSchema),z.lazy(() => IssueUpsertWithWhereUniqueWithoutOrganizationInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => IssueUpdateWithWhereUniqueWithoutOrganizationInputSchema),z.lazy(() => IssueUpdateWithWhereUniqueWithoutOrganizationInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => IssueUpdateManyWithWhereWithoutOrganizationInputSchema),z.lazy(() => IssueUpdateManyWithWhereWithoutOrganizationInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => IssueScalarWhereInputSchema),z.lazy(() => IssueScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default IssueUncheckedUpdateManyWithoutOrganizationNestedInputSchema;
