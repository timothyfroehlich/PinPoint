...
export const MachineUpdateWithoutModelInputSchema: z.ZodType<Prisma.MachineUpdateWithoutModelInput> =
  z
    .object({
      id: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.MachineUpdateWithoutModelInput>;
