...
export const IssueStatusUpdateManyWithoutOrganizationNestedInputSchema: z.ZodType<Prisma.IssueStatusUpdateManyWithoutOrganizationNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => IssueStatusUpsertWithWhereUniqueWithoutOrganizationInputSchema),z.lazy(() => IssueStatusUpsertWithWhereUniqueWithoutOrganizationInputSchema).array() ]).optional(),
  createMany: z.lazy(() => IssueStatusCreateManyOrganizationInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => IssueStatusWhereUniqueInputSchema),z.lazy(() => IssueStatusWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => IssueStatusWhereUniqueInputSchema),z.lazy(() => IssueStatusWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => IssueStatusWhereUniqueInputSchema),z.lazy(() => IssueStatusWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => IssueStatusWhereUniqueInputSchema),z.lazy(() => IssueStatusWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => IssueStatusUpdateWithWhereUniqueWithoutOrganizationInputSchema),z.lazy(() => IssueStatusUpdateWithWhereUniqueWithoutOrganizationInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => IssueStatusUpdateManyWithWhereWithoutOrganizationInputSchema),z.lazy(() => IssueStatusUpdateManyWithWhereWithoutOrganizationInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => IssueStatusScalarWhereInputSchema),z.lazy(() => IssueStatusScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default IssueStatusUpdateManyWithoutOrganizationNestedInputSchema;
