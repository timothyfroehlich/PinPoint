...
export const OrganizationUncheckedCreateWithoutPinballMapConfigInputSchema: z.ZodType<Prisma.OrganizationUncheckedCreateWithoutPinballMapConfigInput> =
  z
    .object({
      ...
      memberships: z
        .lazy(
          () =>
            MembershipUncheckedCreateNestedManyWithoutOrganizationInputSchema,
        )
        .optional(),
      locations: z
        .lazy(
          () => LocationUncheckedCreateNestedManyWithoutOrganizationInputSchema,
        )
        .optional(),
      roles: z
        .lazy(() => RoleUncheckedCreateNestedManyWithoutOrganizationInputSchema)
        .optional(),
      machines: z
        .lazy(
          () => MachineUncheckedCreateNestedManyWithoutOrganizationInputSchema,
        )
        .optional(),
      issues: z
        .lazy(
          () => IssueUncheckedCreateNestedManyWithoutOrganizationInputSchema,
        )
        .optional(),
      priorities: z
        .lazy(
          () => PriorityUncheckedCreateNestedManyWithoutOrganizationInputSchema,
        )
        .optional(),
      issueStatuses: z
        .lazy(
          () =>
            IssueStatusUncheckedCreateNestedManyWithoutOrganizationInputSchema,
        )
        .optional(),
      collectionTypes: z
        .lazy(
          () =>
            CollectionTypeUncheckedCreateNestedManyWithoutOrganizationInputSchema,
        )
        .optional(),
      issueHistory: z
        .lazy(
          () =>
            IssueHistoryUncheckedCreateNestedManyWithoutOrganizationInputSchema,
        )
        .optional(),
      attachments: z
        .lazy(
          () =>
            AttachmentUncheckedCreateNestedManyWithoutOrganizationInputSchema,
        )
        .optional(),
    })
    .strict() as z.ZodType<Prisma.OrganizationUncheckedCreateWithoutPinballMapConfigInput>;

export default OrganizationUncheckedCreateWithoutPinballMapConfigInputSchema;
