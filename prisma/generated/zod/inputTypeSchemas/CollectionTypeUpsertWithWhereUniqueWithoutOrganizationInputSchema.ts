...
export const CollectionTypeUpsertWithWhereUniqueWithoutOrganizationInputSchema: z.ZodType<Prisma.CollectionTypeUpsertWithWhereUniqueWithoutOrganizationInput> = z.object({
  where: z.lazy(() => CollectionTypeWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => CollectionTypeUpdateWithoutOrganizationInputSchema),z.lazy(() => CollectionTypeUncheckedUpdateWithoutOrganizationInputSchema) ]),
  create: z.union([ z.lazy(() => CollectionTypeCreateWithoutOrganizationInputSchema),z.lazy(() => CollectionTypeUncheckedCreateWithoutOrganizationInputSchema) ]),
}).strict();
