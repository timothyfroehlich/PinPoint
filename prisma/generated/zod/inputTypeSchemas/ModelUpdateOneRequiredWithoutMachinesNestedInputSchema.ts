...
export const ModelUpdateOneRequiredWithoutMachinesNestedInputSchema: z.ZodType<Prisma.ModelUpdateOneRequiredWithoutMachinesNestedInput> =
  z
    .object({
      create: z
        .union([
