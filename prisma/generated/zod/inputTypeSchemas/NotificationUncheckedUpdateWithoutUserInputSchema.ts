...
export const NotificationUncheckedUpdateWithoutUserInputSchema: z.ZodType<Prisma.NotificationUncheckedUpdateWithoutUserInput> = z.object({
  ...
  entityType: z.union([ z.lazy(() => NotificationEntitySchema),z.lazy(() => NullableEnumNotificationEntityFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  entityId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
