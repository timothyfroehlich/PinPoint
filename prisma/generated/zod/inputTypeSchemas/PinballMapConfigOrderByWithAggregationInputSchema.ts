...
export const PinballMapConfigOrderByWithAggregationInputSchema: z.ZodType<Prisma.PinballMapConfigOrderByWithAggregationInput> = z.object({
  ...
  lastGlobalSync: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  createMissingModels: z.lazy(() => SortOrderSchema).optional(),
  updateExistingData: z.lazy(() => SortOrderSchema).optional(),
  _count: z.lazy(() => PinballMapConfigCountOrderByAggregateInputSchema).optional(),
  _avg: z.lazy(() => PinballMapConfigAvgOrderByAggregateInputSchema).optional(),
  _max: z.lazy(() => PinballMapConfigMaxOrderByAggregateInputSchema).optional(),
  _min: z.lazy(() => PinballMapConfigMinOrderByAggregateInputSchema).optional(),
  _sum: z.lazy(() => PinballMapConfigSumOrderByAggregateInputSchema).optional()
}).strict();
