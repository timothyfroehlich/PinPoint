...
export const IssueHistoryCreateWithoutActorInputSchema: z.ZodType<Prisma.IssueHistoryCreateWithoutActorInput> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.IssueHistoryCreateWithoutActorInput>;
