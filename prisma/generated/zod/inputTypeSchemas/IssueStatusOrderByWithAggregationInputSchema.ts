...
export const IssueStatusOrderByWithAggregationInputSchema: z.ZodType<Prisma.IssueStatusOrderByWithAggregationInput> =
  z
    .object({
      ...
      _count: z
        .lazy(() => IssueStatusCountOrderByAggregateInputSchema)
        .optional(),
    ...
    .strict() as z.ZodType<Prisma.IssueStatusOrderByWithAggregationInput>;
