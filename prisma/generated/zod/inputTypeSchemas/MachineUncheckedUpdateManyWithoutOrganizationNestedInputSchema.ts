...
export const MachineUncheckedUpdateManyWithoutOrganizationNestedInputSchema: z.ZodType<Prisma.MachineUncheckedUpdateManyWithoutOrganizationNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => MachineCreateWithoutOrganizationInputSchema),
          z.lazy(() => MachineCreateWithoutOrganizationInputSchema).array(),
          z.lazy(() => MachineUncheckedCreateWithoutOrganizationInputSchema),
          z
            .lazy(() => MachineUncheckedCreateWithoutOrganizationInputSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => MachineCreateOrConnectWithoutOrganizationInputSchema),
          z
            .lazy(() => MachineCreateOrConnectWithoutOrganizationInputSchema)
            .array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(
            () => MachineUpsertWithWhereUniqueWithoutOrganizationInputSchema,
          ),
          z
            .lazy(
              () => MachineUpsertWithWhereUniqueWithoutOrganizationInputSchema,
        ...
        .optional(),
      createMany: z
        .lazy(() => MachineCreateManyOrganizationInputEnvelopeSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(
            () => MachineUpdateWithWhereUniqueWithoutOrganizationInputSchema,
          ),
          z
            .lazy(
              () => MachineUpdateWithWhereUniqueWithoutOrganizationInputSchema,
      ...
      updateMany: z
        .union([
          z.lazy(
            () => MachineUpdateManyWithWhereWithoutOrganizationInputSchema,
          ),
          z
            .lazy(
              () => MachineUpdateManyWithWhereWithoutOrganizationInputSchema,
    ...
    .strict() as z.ZodType<Prisma.MachineUncheckedUpdateManyWithoutOrganizationNestedInput>;

export default MachineUncheckedUpdateManyWithoutOrganizationNestedInputSchema;
