...
export const UpvoteWhereUniqueInputSchema: z.ZodType<Prisma.UpvoteWhereUniqueInput> =
  z
    .union([
      z.object({
        id: z.string().cuid(),
        issueId_userId: z.lazy(
          () => UpvoteIssueIdUserIdCompoundUniqueInputSchema,
        ),
      }),
      z.object({
        id: z.string().cuid(),
    ...
    .and(
      z
        .object({
          ...
          issueId_userId: z
            .lazy(() => UpvoteIssueIdUserIdCompoundUniqueInputSchema)
            .optional(),
          AND: z
            .union([
              z.lazy(() => UpvoteWhereInputSchema),
              z.lazy(() => UpvoteWhereInputSchema).array(),
            ])
            .optional(),
          OR: z
            .lazy(() => UpvoteWhereInputSchema)
            .array()
            .optional(),
          NOT: z
            .union([
        ...
        .strict(),
    ) as z.ZodType<Prisma.UpvoteWhereUniqueInput>;
