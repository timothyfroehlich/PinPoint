...
export const OrganizationUpsertWithoutIssueHistoryInputSchema: z.ZodType<Prisma.OrganizationUpsertWithoutIssueHistoryInput> = z.object({
  update: z.union([ z.lazy(() => OrganizationUpdateWithoutIssueHistoryInputSchema),z.lazy(() => OrganizationUncheckedUpdateWithoutIssueHistoryInputSchema) ]),
