...
export const OrganizationUpsertWithoutCollectionTypesInputSchema: z.ZodType<Prisma.OrganizationUpsertWithoutCollectionTypesInput> = z.object({
  update: z.union([ z.lazy(() => OrganizationUpdateWithoutCollectionTypesInputSchema),z.lazy(() => OrganizationUncheckedUpdateWithoutCollectionTypesInputSchema) ]),
  create: z.union([ z.lazy(() => OrganizationCreateWithoutCollectionTypesInputSchema),z.lazy(() => OrganizationUncheckedCreateWithoutCollectionTypesInputSchema) ]),
