...
export const PriorityUpdateInputSchema: z.ZodType<Prisma.PriorityUpdateInput> =
  z
    .object({
      id: z
        .union([
      ...
      organization: z
        .lazy(
          () => OrganizationUpdateOneRequiredWithoutPrioritiesNestedInputSchema,
        )
        .optional(),
      issues: z
    ...
    .strict() as z.ZodType<Prisma.PriorityUpdateInput>;
