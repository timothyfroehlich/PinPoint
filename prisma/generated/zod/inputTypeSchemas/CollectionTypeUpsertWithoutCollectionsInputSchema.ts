...
export const CollectionTypeUpsertWithoutCollectionsInputSchema: z.ZodType<Prisma.CollectionTypeUpsertWithoutCollectionsInput> =
  z
    .object({
      update: z.union([
    ...
    .strict() as z.ZodType<Prisma.CollectionTypeUpsertWithoutCollectionsInput>;
