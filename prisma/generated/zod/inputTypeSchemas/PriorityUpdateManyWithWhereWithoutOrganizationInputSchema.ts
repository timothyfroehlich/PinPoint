...
export const PriorityUpdateManyWithWhereWithoutOrganizationInputSchema: z.ZodType<Prisma.PriorityUpdateManyWithWhereWithoutOrganizationInput> =
  z
    .object({
      where: z.lazy(() => PriorityScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => PriorityUpdateManyMutationInputSchema),
        z.lazy(() => PriorityUncheckedUpdateManyWithoutOrganizationInputSchema),
      ]),
    })
    .strict() as z.ZodType<Prisma.PriorityUpdateManyWithWhereWithoutOrganizationInput>;
