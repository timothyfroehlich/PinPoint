...
export const IssueUncheckedUpdateManyWithoutMachineNestedInputSchema: z.ZodType<Prisma.IssueUncheckedUpdateManyWithoutMachineNestedInput> = z.object({
  create: z.union([ z.lazy(() => IssueCreateWithoutMachineInputSchema),z.lazy(() => IssueCreateWithoutMachineInputSchema).array(),z.lazy(() => IssueUncheckedCreateWithoutMachineInputSchema),z.lazy(() => IssueUncheckedCreateWithoutMachineInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => IssueCreateOrConnectWithoutMachineInputSchema),z.lazy(() => IssueCreateOrConnectWithoutMachineInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => IssueUpsertWithWhereUniqueWithoutMachineInputSchema),z.lazy(() => IssueUpsertWithWhereUniqueWithoutMachineInputSchema).array() ]).optional(),
  createMany: z.lazy(() => IssueCreateManyMachineInputEnvelopeSchema).optional(),
  ...
  update: z.union([ z.lazy(() => IssueUpdateWithWhereUniqueWithoutMachineInputSchema),z.lazy(() => IssueUpdateWithWhereUniqueWithoutMachineInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => IssueUpdateManyWithWhereWithoutMachineInputSchema),z.lazy(() => IssueUpdateManyWithWhereWithoutMachineInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => IssueScalarWhereInputSchema),z.lazy(() => IssueScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default IssueUncheckedUpdateManyWithoutMachineNestedInputSchema;
