...
export const MachineCreateManyLocationInputSchema: z.ZodType<Prisma.MachineCreateManyLocationInput> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.MachineCreateManyLocationInput>;
