...
export const UserUpdateOneRequiredWithoutIssuesCreatedNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutIssuesCreatedNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => UserUpsertWithoutIssuesCreatedInputSchema)
        .optional(),
      connect: z.lazy(() => UserWhereUniqueInputSchema).optional(),
      update: z
        .union([
          z.lazy(() => UserUpdateToOneWithWhereWithoutIssuesCreatedInputSchema),
          z.lazy(() => UserUpdateWithoutIssuesCreatedInputSchema),
          z.lazy(() => UserUncheckedUpdateWithoutIssuesCreatedInputSchema),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.UserUpdateOneRequiredWithoutIssuesCreatedNestedInput>;
