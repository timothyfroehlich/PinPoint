...
export const LocationCreateNestedOneWithoutMachinesInputSchema: z.ZodType<Prisma.LocationCreateNestedOneWithoutMachinesInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.LocationCreateNestedOneWithoutMachinesInput>;
