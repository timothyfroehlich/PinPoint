...
export const IssueUpsertWithoutAttachmentsInputSchema: z.ZodType<Prisma.IssueUpsertWithoutAttachmentsInput> =
  z
    .object({
      update: z.union([
    ...
    .strict() as z.ZodType<Prisma.IssueUpsertWithoutAttachmentsInput>;
