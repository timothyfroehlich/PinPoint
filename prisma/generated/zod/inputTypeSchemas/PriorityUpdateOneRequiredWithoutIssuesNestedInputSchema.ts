...
export const PriorityUpdateOneRequiredWithoutIssuesNestedInputSchema: z.ZodType<Prisma.PriorityUpdateOneRequiredWithoutIssuesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => PriorityUpdateToOneWithWhereWithoutIssuesInputSchema),
          z.lazy(() => PriorityUpdateWithoutIssuesInputSchema),
          z.lazy(() => PriorityUncheckedUpdateWithoutIssuesInputSchema),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.PriorityUpdateOneRequiredWithoutIssuesNestedInput>;
