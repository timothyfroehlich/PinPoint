...
export const RoleUpdateWithoutOrganizationInputSchema: z.ZodType<Prisma.RoleUpdateWithoutOrganizationInput> =
  z
    .object({
      id: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.RoleUpdateWithoutOrganizationInput>;
