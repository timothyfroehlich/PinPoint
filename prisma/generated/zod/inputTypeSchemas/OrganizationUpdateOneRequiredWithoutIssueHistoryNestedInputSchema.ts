...
export const OrganizationUpdateOneRequiredWithoutIssueHistoryNestedInputSchema: z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutIssueHistoryNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => OrganizationUpsertWithoutIssueHistoryInputSchema)
        .optional(),
      ...
      update: z
        .union([
          z.lazy(
            () =>
              OrganizationUpdateToOneWithWhereWithoutIssueHistoryInputSchema,
          ),
          z.lazy(() => OrganizationUpdateWithoutIssueHistoryInputSchema),
          z.lazy(
            () => OrganizationUncheckedUpdateWithoutIssueHistoryInputSchema,
          ),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutIssueHistoryNestedInput>;
