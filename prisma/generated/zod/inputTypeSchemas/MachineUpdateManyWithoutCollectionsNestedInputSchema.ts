...
export const MachineUpdateManyWithoutCollectionsNestedInputSchema: z.ZodType<Prisma.MachineUpdateManyWithoutCollectionsNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => MachineUpsertWithWhereUniqueWithoutCollectionsInputSchema),z.lazy(() => MachineUpsertWithWhereUniqueWithoutCollectionsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => MachineUpdateWithWhereUniqueWithoutCollectionsInputSchema),z.lazy(() => MachineUpdateWithWhereUniqueWithoutCollectionsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => MachineUpdateManyWithWhereWithoutCollectionsInputSchema),z.lazy(() => MachineUpdateManyWithWhereWithoutCollectionsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => MachineScalarWhereInputSchema),z.lazy(() => MachineScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default MachineUpdateManyWithoutCollectionsNestedInputSchema;
