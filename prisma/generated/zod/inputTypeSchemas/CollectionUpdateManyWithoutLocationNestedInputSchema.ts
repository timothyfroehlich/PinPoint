...
export const CollectionUpdateManyWithoutLocationNestedInputSchema: z.ZodType<Prisma.CollectionUpdateManyWithoutLocationNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => CollectionCreateWithoutLocationInputSchema),
          z.lazy(() => CollectionCreateWithoutLocationInputSchema).array(),
          z.lazy(() => CollectionUncheckedCreateWithoutLocationInputSchema),
          z
            .lazy(() => CollectionUncheckedCreateWithoutLocationInputSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => CollectionCreateOrConnectWithoutLocationInputSchema),
          z
            .lazy(() => CollectionCreateOrConnectWithoutLocationInputSchema)
            .array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(
            () => CollectionUpsertWithWhereUniqueWithoutLocationInputSchema,
          ),
          z
            .lazy(
              () => CollectionUpsertWithWhereUniqueWithoutLocationInputSchema,
        ...
        .optional(),
      createMany: z
        .lazy(() => CollectionCreateManyLocationInputEnvelopeSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(
            () => CollectionUpdateWithWhereUniqueWithoutLocationInputSchema,
          ),
          z
            .lazy(
              () => CollectionUpdateWithWhereUniqueWithoutLocationInputSchema,
      ...
      updateMany: z
        .union([
          z.lazy(() => CollectionUpdateManyWithWhereWithoutLocationInputSchema),
          z
            .lazy(() => CollectionUpdateManyWithWhereWithoutLocationInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
    ...
    .strict() as z.ZodType<Prisma.CollectionUpdateManyWithoutLocationNestedInput>;

export default CollectionUpdateManyWithoutLocationNestedInputSchema;
