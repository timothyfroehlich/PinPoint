...
export const IssueStatusUpdateWithoutIssuesInputSchema: z.ZodType<Prisma.IssueStatusUpdateWithoutIssuesInput> =
  z
    .object({
      id: z
        .union([
      ...
      organization: z
        .lazy(
          () =>
            OrganizationUpdateOneRequiredWithoutIssueStatusesNestedInputSchema,
        )
        .optional(),
    })
    .strict() as z.ZodType<Prisma.IssueStatusUpdateWithoutIssuesInput>;

export default IssueStatusUpdateWithoutIssuesInputSchema;
