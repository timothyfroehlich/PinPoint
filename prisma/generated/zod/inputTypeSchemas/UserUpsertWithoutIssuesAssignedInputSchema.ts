...
export const UserUpsertWithoutIssuesAssignedInputSchema: z.ZodType<Prisma.UserUpsertWithoutIssuesAssignedInput> =
  z
    .object({
      update: z.union([
    ...
    .strict() as z.ZodType<Prisma.UserUpsertWithoutIssuesAssignedInput>;
