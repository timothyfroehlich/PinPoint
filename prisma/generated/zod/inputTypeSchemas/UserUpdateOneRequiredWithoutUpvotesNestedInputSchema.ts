...
export const UserUpdateOneRequiredWithoutUpvotesNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutUpvotesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => UserUpdateToOneWithWhereWithoutUpvotesInputSchema),z.lazy(() => UserUpdateWithoutUpvotesInputSchema),z.lazy(() => UserUncheckedUpdateWithoutUpvotesInputSchema) ]).optional(),
}).strict();
