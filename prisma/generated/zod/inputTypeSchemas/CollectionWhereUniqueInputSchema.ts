...
export const CollectionWhereUniqueInputSchema: z.ZodType<Prisma.CollectionWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    name_typeId_locationId: z.lazy(() => CollectionNameTypeIdLocationIdCompoundUniqueInputSchema)
  }),
  z.object({
    id: z.string().cuid(),
  }),
...
.and(z.object({
  ...
  name_typeId_locationId: z.lazy(() => CollectionNameTypeIdLocationIdCompoundUniqueInputSchema).optional(),
  ...
  isSmart: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  isManual: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  ...
  type: z.union([ z.lazy(() => CollectionTypeScalarRelationFilterSchema),z.lazy(() => CollectionTypeWhereInputSchema) ]).optional(),
