...
export const UserCreateNestedOneWithoutUpvotesInputSchema: z.ZodType<Prisma.UserCreateNestedOneWithoutUpvotesInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.UserCreateNestedOneWithoutUpvotesInput>;
