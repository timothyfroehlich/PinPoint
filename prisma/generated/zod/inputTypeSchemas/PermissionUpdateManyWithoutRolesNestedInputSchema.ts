...
export const PermissionUpdateManyWithoutRolesNestedInputSchema: z.ZodType<Prisma.PermissionUpdateManyWithoutRolesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => PermissionUpsertWithWhereUniqueWithoutRolesInputSchema),
          z
            .lazy(() => PermissionUpsertWithWhereUniqueWithoutRolesInputSchema)
            .array(),
        ])
        .optional(),
      set: z
      ...
      update: z
        .union([
          z.lazy(() => PermissionUpdateWithWhereUniqueWithoutRolesInputSchema),
          z
            .lazy(() => PermissionUpdateWithWhereUniqueWithoutRolesInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => PermissionUpdateManyWithWhereWithoutRolesInputSchema),
          z
            .lazy(() => PermissionUpdateManyWithWhereWithoutRolesInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
        .union([
          z.lazy(() => PermissionScalarWhereInputSchema),
          z.lazy(() => PermissionScalarWhereInputSchema).array(),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.PermissionUpdateManyWithoutRolesNestedInput>;

export default PermissionUpdateManyWithoutRolesNestedInputSchema;
