...
export const MembershipUpsertWithWhereUniqueWithoutRoleInputSchema: z.ZodType<Prisma.MembershipUpsertWithWhereUniqueWithoutRoleInput> =
  z
    .object({
      where: z.lazy(() => MembershipWhereUniqueInputSchema),
      update: z.union([
        z.lazy(() => MembershipUpdateWithoutRoleInputSchema),
        z.lazy(() => MembershipUncheckedUpdateWithoutRoleInputSchema),
      ]),
      create: z.union([
    ...
    .strict() as z.ZodType<Prisma.MembershipUpsertWithWhereUniqueWithoutRoleInput>;
