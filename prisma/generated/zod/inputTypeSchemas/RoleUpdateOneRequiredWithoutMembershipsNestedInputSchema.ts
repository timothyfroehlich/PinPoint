...
export const RoleUpdateOneRequiredWithoutMembershipsNestedInputSchema: z.ZodType<Prisma.RoleUpdateOneRequiredWithoutMembershipsNestedInput> =
  z
    .object({
      create: z
        .union([
