...
export const UpvoteUpdateWithoutIssueInputSchema: z.ZodType<Prisma.UpvoteUpdateWithoutIssueInput> =
  z
    .object({
      id: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.UpvoteUpdateWithoutIssueInput>;
