...
export const AttachmentUpdateWithoutIssueInputSchema: z.ZodType<Prisma.AttachmentUpdateWithoutIssueInput> = z.object({
  ...
  organization: z.lazy(() => OrganizationUpdateOneRequiredWithoutAttachmentsNestedInputSchema).optional()
}).strict();
