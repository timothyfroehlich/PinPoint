...
export const EnumNotificationFrequencyFilterSchema: z.ZodType<Prisma.EnumNotificationFrequencyFilter> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.EnumNotificationFrequencyFilter>;
