...
export const PinballMapConfigWhereUniqueInputSchema: z.ZodType<Prisma.PinballMapConfigWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
...
.and(z.object({
  ...
  syncIntervalHours: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
