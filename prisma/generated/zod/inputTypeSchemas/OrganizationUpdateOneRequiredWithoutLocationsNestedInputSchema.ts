...
export const OrganizationUpdateOneRequiredWithoutLocationsNestedInputSchema: z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutLocationsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => OrganizationUpdateToOneWithWhereWithoutLocationsInputSchema),z.lazy(() => OrganizationUpdateWithoutLocationsInputSchema),z.lazy(() => OrganizationUncheckedUpdateWithoutLocationsInputSchema) ]).optional(),
}).strict();
