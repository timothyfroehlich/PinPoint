...
export const UserUpsertWithoutOwnedMachinesInputSchema: z.ZodType<Prisma.UserUpsertWithoutOwnedMachinesInput> =
  z
    .object({
      update: z.union([
    ...
    .strict() as z.ZodType<Prisma.UserUpsertWithoutOwnedMachinesInput>;
