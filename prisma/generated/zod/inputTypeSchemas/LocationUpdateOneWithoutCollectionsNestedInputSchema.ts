...
export const LocationUpdateOneWithoutCollectionsNestedInputSchema: z.ZodType<Prisma.LocationUpdateOneWithoutCollectionsNestedInput> = z.object({
  ...
  upsert: z.lazy(() => LocationUpsertWithoutCollectionsInputSchema).optional(),
  ...
  update: z.union([ z.lazy(() => LocationUpdateToOneWithWhereWithoutCollectionsInputSchema),z.lazy(() => LocationUpdateWithoutCollectionsInputSchema),z.lazy(() => LocationUncheckedUpdateWithoutCollectionsInputSchema) ]).optional(),
}).strict();
