...
export const UserUpdateOneWithoutActivityHistoryNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutActivityHistoryNestedInput> =
  z
    .object({
      create: z
        .union([
        ...
        .optional(),
      connectOrCreate: z
        .lazy(() => UserCreateOrConnectWithoutActivityHistoryInputSchema)
        .optional(),
      upsert: z
        .lazy(() => UserUpsertWithoutActivityHistoryInputSchema)
        .optional(),
      disconnect: z
      ...
      update: z
        .union([
          z.lazy(
            () => UserUpdateToOneWithWhereWithoutActivityHistoryInputSchema,
          ),
    ...
    .strict() as z.ZodType<Prisma.UserUpdateOneWithoutActivityHistoryNestedInput>;
