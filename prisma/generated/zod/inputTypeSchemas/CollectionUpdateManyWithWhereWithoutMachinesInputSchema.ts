...
export const CollectionUpdateManyWithWhereWithoutMachinesInputSchema: z.ZodType<Prisma.CollectionUpdateManyWithWhereWithoutMachinesInput> =
  z
    .object({
      where: z.lazy(() => CollectionScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => CollectionUpdateManyMutationInputSchema),
        z.lazy(() => CollectionUncheckedUpdateManyWithoutMachinesInputSchema),
      ]),
    })
    .strict() as z.ZodType<Prisma.CollectionUpdateManyWithWhereWithoutMachinesInput>;
