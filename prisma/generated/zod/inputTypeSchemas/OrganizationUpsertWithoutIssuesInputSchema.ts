...
export const OrganizationUpsertWithoutIssuesInputSchema: z.ZodType<Prisma.OrganizationUpsertWithoutIssuesInput> = z.object({
  update: z.union([ z.lazy(() => OrganizationUpdateWithoutIssuesInputSchema),z.lazy(() => OrganizationUncheckedUpdateWithoutIssuesInputSchema) ]),
  create: z.union([ z.lazy(() => OrganizationCreateWithoutIssuesInputSchema),z.lazy(() => OrganizationUncheckedCreateWithoutIssuesInputSchema) ]),
