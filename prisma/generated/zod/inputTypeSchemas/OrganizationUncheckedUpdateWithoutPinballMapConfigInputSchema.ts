...
import { IssueUncheckedUpdateManyWithoutOrganizationNestedInputSchema } from './IssueUncheckedUpdateManyWithoutOrganizationNestedInputSchema';
...
export const OrganizationUncheckedUpdateWithoutPinballMapConfigInputSchema: z.ZodType<Prisma.OrganizationUncheckedUpdateWithoutPinballMapConfigInput> = z.object({
  ...
  memberships: z.lazy(() => MembershipUncheckedUpdateManyWithoutOrganizationNestedInputSchema).optional(),
  locations: z.lazy(() => LocationUncheckedUpdateManyWithoutOrganizationNestedInputSchema).optional(),
  roles: z.lazy(() => RoleUncheckedUpdateManyWithoutOrganizationNestedInputSchema).optional(),
  machines: z.lazy(() => MachineUncheckedUpdateManyWithoutOrganizationNestedInputSchema).optional(),
  issues: z.lazy(() => IssueUncheckedUpdateManyWithoutOrganizationNestedInputSchema).optional(),
  priorities: z.lazy(() => PriorityUncheckedUpdateManyWithoutOrganizationNestedInputSchema).optional(),
  issueStatuses: z.lazy(() => IssueStatusUncheckedUpdateManyWithoutOrganizationNestedInputSchema).optional(),
  collectionTypes: z.lazy(() => CollectionTypeUncheckedUpdateManyWithoutOrganizationNestedInputSchema).optional(),
  issueHistory: z.lazy(() => IssueHistoryUncheckedUpdateManyWithoutOrganizationNestedInputSchema).optional(),
  attachments: z.lazy(() => AttachmentUncheckedUpdateManyWithoutOrganizationNestedInputSchema).optional()
}).strict();

export default OrganizationUncheckedUpdateWithoutPinballMapConfigInputSchema;
