...
export const IssueUncheckedUpdateManyWithoutPriorityNestedInputSchema: z.ZodType<Prisma.IssueUncheckedUpdateManyWithoutPriorityNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => IssueUpsertWithWhereUniqueWithoutPriorityInputSchema),
          z
            .lazy(() => IssueUpsertWithWhereUniqueWithoutPriorityInputSchema)
            .array(),
        ])
        .optional(),
      createMany: z
      ...
      update: z
        .union([
          z.lazy(() => IssueUpdateWithWhereUniqueWithoutPriorityInputSchema),
          z
            .lazy(() => IssueUpdateWithWhereUniqueWithoutPriorityInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => IssueUpdateManyWithWhereWithoutPriorityInputSchema),
          z
            .lazy(() => IssueUpdateManyWithWhereWithoutPriorityInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
    ...
    .strict() as z.ZodType<Prisma.IssueUncheckedUpdateManyWithoutPriorityNestedInput>;

export default IssueUncheckedUpdateManyWithoutPriorityNestedInputSchema;
