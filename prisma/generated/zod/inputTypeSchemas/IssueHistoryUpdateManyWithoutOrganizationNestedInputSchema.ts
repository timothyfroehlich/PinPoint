...
export const IssueHistoryUpdateManyWithoutOrganizationNestedInputSchema: z.ZodType<Prisma.IssueHistoryUpdateManyWithoutOrganizationNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => IssueHistoryUpsertWithWhereUniqueWithoutOrganizationInputSchema),z.lazy(() => IssueHistoryUpsertWithWhereUniqueWithoutOrganizationInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => IssueHistoryUpdateWithWhereUniqueWithoutOrganizationInputSchema),z.lazy(() => IssueHistoryUpdateWithWhereUniqueWithoutOrganizationInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => IssueHistoryUpdateManyWithWhereWithoutOrganizationInputSchema),z.lazy(() => IssueHistoryUpdateManyWithWhereWithoutOrganizationInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => IssueHistoryScalarWhereInputSchema),z.lazy(() => IssueHistoryScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default IssueHistoryUpdateManyWithoutOrganizationNestedInputSchema;
