...
.and(z.object({
  ...
  machine: z.union([ z.lazy(() => MachineScalarRelationFilterSchema),z.lazy(() => MachineWhereInputSchema) ]).optional(),
  priority: z.union([ z.lazy(() => PriorityScalarRelationFilterSchema),z.lazy(() => PriorityWhereInputSchema) ]).optional(),
  status: z.union([ z.lazy(() => IssueStatusScalarRelationFilterSchema),z.lazy(() => IssueStatusWhereInputSchema) ]).optional(),
...
export default IssueWhereUniqueInputSchema;
