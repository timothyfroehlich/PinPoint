...
export const IssueHistoryUpsertWithWhereUniqueWithoutOrganizationInputSchema: z.ZodType<Prisma.IssueHistoryUpsertWithWhereUniqueWithoutOrganizationInput> =
  z
    .object({
      ...
      create: z.union([
        ...
        z.lazy(() => IssueHistoryUncheckedCreateWithoutOrganizationInputSchema),
      ]),
    })
    .strict() as z.ZodType<Prisma.IssueHistoryUpsertWithWhereUniqueWithoutOrganizationInput>;
