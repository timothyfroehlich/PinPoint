...
export const IssueCreateNestedManyWithoutOrganizationInputSchema: z.ZodType<Prisma.IssueCreateNestedManyWithoutOrganizationInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.IssueCreateNestedManyWithoutOrganizationInput>;
