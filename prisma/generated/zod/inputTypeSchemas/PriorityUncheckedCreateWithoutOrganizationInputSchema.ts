...
export const PriorityUncheckedCreateWithoutOrganizationInputSchema: z.ZodType<Prisma.PriorityUncheckedCreateWithoutOrganizationInput> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.PriorityUncheckedCreateWithoutOrganizationInput>;
