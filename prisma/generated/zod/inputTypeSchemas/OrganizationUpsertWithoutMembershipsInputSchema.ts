...
export const OrganizationUpsertWithoutMembershipsInputSchema: z.ZodType<Prisma.OrganizationUpsertWithoutMembershipsInput> = z.object({
  update: z.union([ z.lazy(() => OrganizationUpdateWithoutMembershipsInputSchema),z.lazy(() => OrganizationUncheckedUpdateWithoutMembershipsInputSchema) ]),
  create: z.union([ z.lazy(() => OrganizationCreateWithoutMembershipsInputSchema),z.lazy(() => OrganizationUncheckedCreateWithoutMembershipsInputSchema) ]),
