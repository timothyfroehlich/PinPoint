...
export const MachineUpdateManyWithWhereWithoutOwnerInputSchema: z.ZodType<Prisma.MachineUpdateManyWithWhereWithoutOwnerInput> =
  z
    .object({
      where: z.lazy(() => MachineScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => MachineUpdateManyMutationInputSchema),
        z.lazy(() => MachineUncheckedUpdateManyWithoutOwnerInputSchema),
      ]),
    })
    .strict() as z.ZodType<Prisma.MachineUpdateManyWithWhereWithoutOwnerInput>;
