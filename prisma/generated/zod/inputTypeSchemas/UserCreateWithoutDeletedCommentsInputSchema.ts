...
export const UserCreateWithoutDeletedCommentsInputSchema: z.ZodType<Prisma.UserCreateWithoutDeletedCommentsInput> =
  z
    .object({
      ...
      sessions: z
        ...
        .optional(),
      memberships: z
        .lazy(() => MembershipCreateNestedManyWithoutUserInputSchema)
        .optional(),
      ownedMachines: z
        .lazy(() => MachineCreateNestedManyWithoutOwnerInputSchema)
        .optional(),
      issuesCreated: z
        .lazy(() => IssueCreateNestedManyWithoutCreatedByInputSchema)
        .optional(),
      issuesAssigned: z
        .lazy(() => IssueCreateNestedManyWithoutAssignedToInputSchema)
        .optional(),
      comments: z
        .lazy(() => CommentCreateNestedManyWithoutAuthorInputSchema)
        .optional(),
      upvotes: z
        .lazy(() => UpvoteCreateNestedManyWithoutUserInputSchema)
        .optional(),
      activityHistory: z
        .lazy(() => IssueHistoryCreateNestedManyWithoutActorInputSchema)
        .optional(),
      notifications: z
        .lazy(() => NotificationCreateNestedManyWithoutUserInputSchema)
        .optional(),
    })
    .strict() as z.ZodType<Prisma.UserCreateWithoutDeletedCommentsInput>;

export default UserCreateWithoutDeletedCommentsInputSchema;
