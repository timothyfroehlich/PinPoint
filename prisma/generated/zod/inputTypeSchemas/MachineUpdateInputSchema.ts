...
export const MachineUpdateInputSchema: z.ZodType<Prisma.MachineUpdateInput> = z
  .object({
    id: z
      .union([
        z.string().cuid(),
    ...
    qrCodeGeneratedAt: z
      ...
      .nullable(),
    organization: z
      .lazy(() => OrganizationUpdateOneRequiredWithoutMachinesNestedInputSchema)
      .optional(),
    location: z
  ...
  .strict() as z.ZodType<Prisma.MachineUpdateInput>;

export default MachineUpdateInputSchema;
