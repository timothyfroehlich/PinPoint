...
export const UserCreateNestedOneWithoutDeletedCommentsInputSchema: z.ZodType<Prisma.UserCreateNestedOneWithoutDeletedCommentsInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.UserCreateNestedOneWithoutDeletedCommentsInput>;
