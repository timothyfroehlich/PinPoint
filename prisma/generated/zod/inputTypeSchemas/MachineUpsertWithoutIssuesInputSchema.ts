...
export const MachineUpsertWithoutIssuesInputSchema: z.ZodType<Prisma.MachineUpsertWithoutIssuesInput> =
  z
    .object({
      update: z.union([
    ...
    .strict() as z.ZodType<Prisma.MachineUpsertWithoutIssuesInput>;
