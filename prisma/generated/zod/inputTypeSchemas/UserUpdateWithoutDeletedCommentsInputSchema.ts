...
export const UserUpdateWithoutDeletedCommentsInputSchema: z.ZodType<Prisma.UserUpdateWithoutDeletedCommentsInput> =
  z
    .object({
      id: z
        .union([
      ...
      comments: z
        ...
        .optional(),
      upvotes: z
        .lazy(() => UpvoteUpdateManyWithoutUserNestedInputSchema)
        .optional(),
      activityHistory: z
    ...
    .strict() as z.ZodType<Prisma.UserUpdateWithoutDeletedCommentsInput>;

export default UserUpdateWithoutDeletedCommentsInputSchema;
