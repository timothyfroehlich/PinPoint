...
export const IssueUpsertWithWhereUniqueWithoutMachineInputSchema: z.ZodType<Prisma.IssueUpsertWithWhereUniqueWithoutMachineInput> = z.object({
  where: z.lazy(() => IssueWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => IssueUpdateWithoutMachineInputSchema),z.lazy(() => IssueUncheckedUpdateWithoutMachineInputSchema) ]),
