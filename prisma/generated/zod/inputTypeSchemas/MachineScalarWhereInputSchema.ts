...
export const MachineScalarWhereInputSchema: z.ZodType<Prisma.MachineScalarWhereInput> =
  z
    .object({
      AND: z
        .union([
        ...
        .optional(),
      OR: z
        .lazy(() => MachineScalarWhereInputSchema)
        .array()
        .optional(),
      NOT: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.MachineScalarWhereInput>;
