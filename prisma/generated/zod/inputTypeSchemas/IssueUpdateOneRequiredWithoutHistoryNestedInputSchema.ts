...
export const IssueUpdateOneRequiredWithoutHistoryNestedInputSchema: z.ZodType<Prisma.IssueUpdateOneRequiredWithoutHistoryNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => IssueUpdateToOneWithWhereWithoutHistoryInputSchema),
          z.lazy(() => IssueUpdateWithoutHistoryInputSchema),
          z.lazy(() => IssueUncheckedUpdateWithoutHistoryInputSchema),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.IssueUpdateOneRequiredWithoutHistoryNestedInput>;
