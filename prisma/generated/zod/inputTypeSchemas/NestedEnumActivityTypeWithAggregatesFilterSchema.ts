...
export const NestedEnumActivityTypeWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumActivityTypeWithAggregatesFilter> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.NestedEnumActivityTypeWithAggregatesFilter>;
