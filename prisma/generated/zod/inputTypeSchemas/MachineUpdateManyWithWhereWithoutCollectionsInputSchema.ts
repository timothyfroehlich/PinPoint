...
export const MachineUpdateManyWithWhereWithoutCollectionsInputSchema: z.ZodType<Prisma.MachineUpdateManyWithWhereWithoutCollectionsInput> = z.object({
  where: z.lazy(() => MachineScalarWhereInputSchema),
  data: z.union([ z.lazy(() => MachineUpdateManyMutationInputSchema),z.lazy(() => MachineUncheckedUpdateManyWithoutCollectionsInputSchema) ]),
}).strict();
