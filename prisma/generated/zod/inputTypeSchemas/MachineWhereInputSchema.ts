...
export const MachineWhereInputSchema: z.ZodType<Prisma.MachineWhereInput> = z
  .object({
    AND: z
      .union([
  ...
  .strict() as z.ZodType<Prisma.MachineWhereInput>;

export default MachineWhereInputSchema;
