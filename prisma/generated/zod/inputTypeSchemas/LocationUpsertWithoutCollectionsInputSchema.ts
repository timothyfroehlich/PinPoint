...
export const LocationUpsertWithoutCollectionsInputSchema: z.ZodType<Prisma.LocationUpsertWithoutCollectionsInput> = z.object({
  update: z.union([ z.lazy(() => LocationUpdateWithoutCollectionsInputSchema),z.lazy(() => LocationUncheckedUpdateWithoutCollectionsInputSchema) ]),
  create: z.union([ z.lazy(() => LocationCreateWithoutCollectionsInputSchema),z.lazy(() => LocationUncheckedCreateWithoutCollectionsInputSchema) ]),
