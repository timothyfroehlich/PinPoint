...
export const MachineUpdateOneRequiredWithoutIssuesNestedInputSchema: z.ZodType<Prisma.MachineUpdateOneRequiredWithoutIssuesNestedInput> = z.object({
  create: z.union([ z.lazy(() => MachineCreateWithoutIssuesInputSchema),z.lazy(() => MachineUncheckedCreateWithoutIssuesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => MachineCreateOrConnectWithoutIssuesInputSchema).optional(),
  upsert: z.lazy(() => MachineUpsertWithoutIssuesInputSchema).optional(),
  connect: z.lazy(() => MachineWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => MachineUpdateToOneWithWhereWithoutIssuesInputSchema),z.lazy(() => MachineUpdateWithoutIssuesInputSchema),z.lazy(() => MachineUncheckedUpdateWithoutIssuesInputSchema) ]).optional(),
}).strict();
