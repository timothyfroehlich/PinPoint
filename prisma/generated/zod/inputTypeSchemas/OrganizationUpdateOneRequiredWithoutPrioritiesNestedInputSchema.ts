...
export const OrganizationUpdateOneRequiredWithoutPrioritiesNestedInputSchema: z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutPrioritiesNestedInput> = z.object({
  create: z.union([ z.lazy(() => OrganizationCreateWithoutPrioritiesInputSchema),z.lazy(() => OrganizationUncheckedCreateWithoutPrioritiesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => OrganizationCreateOrConnectWithoutPrioritiesInputSchema).optional(),
  upsert: z.lazy(() => OrganizationUpsertWithoutPrioritiesInputSchema).optional(),
  connect: z.lazy(() => OrganizationWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => OrganizationUpdateToOneWithWhereWithoutPrioritiesInputSchema),z.lazy(() => OrganizationUpdateWithoutPrioritiesInputSchema),z.lazy(() => OrganizationUncheckedUpdateWithoutPrioritiesInputSchema) ]).optional(),
}).strict();
