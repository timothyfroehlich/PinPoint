...
export const MachineUpdateWithoutOrganizationInputSchema: z.ZodType<Prisma.MachineUpdateWithoutOrganizationInput> =
  z
    .object({
      id: z
        .union([
      ...
      issues: z
        ...
        .optional(),
      collections: z
        .lazy(() => CollectionUpdateManyWithoutMachinesNestedInputSchema)
        .optional(),
    })
    .strict() as z.ZodType<Prisma.MachineUpdateWithoutOrganizationInput>;

export default MachineUpdateWithoutOrganizationInputSchema;
