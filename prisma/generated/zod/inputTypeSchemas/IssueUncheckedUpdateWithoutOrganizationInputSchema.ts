...
export const IssueUncheckedUpdateWithoutOrganizationInputSchema: z.ZodType<Prisma.IssueUncheckedUpdateWithoutOrganizationInput> = z.object({
  ...
  machineId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  upvotes: z.lazy(() => UpvoteUncheckedUpdateManyWithoutIssueNestedInputSchema).optional()
}).strict();

export default IssueUncheckedUpdateWithoutOrganizationInputSchema;
