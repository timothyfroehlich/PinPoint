...
export const LocationUpdateOneRequiredWithoutMachinesNestedInputSchema: z.ZodType<Prisma.LocationUpdateOneRequiredWithoutMachinesNestedInput> =
  z
    .object({
      create: z
        .union([
