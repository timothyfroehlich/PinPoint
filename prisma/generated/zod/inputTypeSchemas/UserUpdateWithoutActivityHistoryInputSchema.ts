...
export const UserUpdateWithoutActivityHistoryInputSchema: z.ZodType<Prisma.UserUpdateWithoutActivityHistoryInput> = z.object({
  ...
  ownedMachines: z.lazy(() => MachineUpdateManyWithoutOwnerNestedInputSchema).optional(),
