...
export const MachineUncheckedUpdateManyWithoutModelNestedInputSchema: z.ZodType<Prisma.MachineUncheckedUpdateManyWithoutModelNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => MachineUpsertWithWhereUniqueWithoutModelInputSchema),z.lazy(() => MachineUpsertWithWhereUniqueWithoutModelInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => MachineUpdateWithWhereUniqueWithoutModelInputSchema),z.lazy(() => MachineUpdateWithWhereUniqueWithoutModelInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => MachineUpdateManyWithWhereWithoutModelInputSchema),z.lazy(() => MachineUpdateManyWithWhereWithoutModelInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => MachineScalarWhereInputSchema),z.lazy(() => MachineScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default MachineUncheckedUpdateManyWithoutModelNestedInputSchema;
