...
export const IssueCreateOrConnectWithoutUpvotesInputSchema: z.ZodType<Prisma.IssueCreateOrConnectWithoutUpvotesInput> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.IssueCreateOrConnectWithoutUpvotesInput>;
