...
export const OrganizationUpdateOneRequiredWithoutMachinesNestedInputSchema: z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutMachinesNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => OrganizationCreateWithoutMachinesInputSchema),
          z.lazy(() => OrganizationUncheckedCreateWithoutMachinesInputSchema),
        ])
        .optional(),
      connectOrCreate: z
        .lazy(() => OrganizationCreateOrConnectWithoutMachinesInputSchema)
        .optional(),
      upsert: z
        .lazy(() => OrganizationUpsertWithoutMachinesInputSchema)
        .optional(),
      connect: z.lazy(() => OrganizationWhereUniqueInputSchema).optional(),
      update: z
        .union([
          z.lazy(
            () => OrganizationUpdateToOneWithWhereWithoutMachinesInputSchema,
          ),
          z.lazy(() => OrganizationUpdateWithoutMachinesInputSchema),
          z.lazy(() => OrganizationUncheckedUpdateWithoutMachinesInputSchema),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutMachinesNestedInput>;
