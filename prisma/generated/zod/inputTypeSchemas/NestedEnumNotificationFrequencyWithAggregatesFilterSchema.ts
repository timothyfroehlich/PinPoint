...
export const NestedEnumNotificationFrequencyWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumNotificationFrequencyWithAggregatesFilter> =
  z
    .object({
      ...
      not: z
        .union([
          ...
          z.lazy(
            () => NestedEnumNotificationFrequencyWithAggregatesFilterSchema,
          ),
        ])
        .optional(),
      _count: z.lazy(() => NestedIntFilterSchema).optional(),
      _min: z
        .lazy(() => NestedEnumNotificationFrequencyFilterSchema)
        .optional(),
      _max: z
        .lazy(() => NestedEnumNotificationFrequencyFilterSchema)
        .optional(),
    })
    .strict() as z.ZodType<Prisma.NestedEnumNotificationFrequencyWithAggregatesFilter>;
