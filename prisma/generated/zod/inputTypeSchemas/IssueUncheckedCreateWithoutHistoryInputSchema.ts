...
export const IssueUncheckedCreateWithoutHistoryInputSchema: z.ZodType<Prisma.IssueUncheckedCreateWithoutHistoryInput> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.IssueUncheckedCreateWithoutHistoryInput>;
