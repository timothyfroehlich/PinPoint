...
export const RoleUncheckedUpdateManyWithoutPermissionsNestedInputSchema: z.ZodType<Prisma.RoleUncheckedUpdateManyWithoutPermissionsNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => RoleUpsertWithWhereUniqueWithoutPermissionsInputSchema),
          z
            .lazy(() => RoleUpsertWithWhereUniqueWithoutPermissionsInputSchema)
            .array(),
        ])
        .optional(),
      set: z
      ...
      update: z
        .union([
          z.lazy(() => RoleUpdateWithWhereUniqueWithoutPermissionsInputSchema),
          z
            .lazy(() => RoleUpdateWithWhereUniqueWithoutPermissionsInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => RoleUpdateManyWithWhereWithoutPermissionsInputSchema),
          z
            .lazy(() => RoleUpdateManyWithWhereWithoutPermissionsInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
    ...
    .strict() as z.ZodType<Prisma.RoleUncheckedUpdateManyWithoutPermissionsNestedInput>;

export default RoleUncheckedUpdateManyWithoutPermissionsNestedInputSchema;
