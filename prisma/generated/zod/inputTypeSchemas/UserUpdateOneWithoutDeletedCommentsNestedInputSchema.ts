...
export const UserUpdateOneWithoutDeletedCommentsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutDeletedCommentsNestedInput> =
  z
    .object({
      create: z
        .union([
        ...
        .optional(),
      connectOrCreate: z
        .lazy(() => UserCreateOrConnectWithoutDeletedCommentsInputSchema)
        .optional(),
      upsert: z
        .lazy(() => UserUpsertWithoutDeletedCommentsInputSchema)
        .optional(),
      disconnect: z
      ...
      update: z
        .union([
          z.lazy(
            () => UserUpdateToOneWithWhereWithoutDeletedCommentsInputSchema,
          ),
    ...
    .strict() as z.ZodType<Prisma.UserUpdateOneWithoutDeletedCommentsNestedInput>;
