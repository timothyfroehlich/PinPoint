...
export const IssueStatusUpsertWithWhereUniqueWithoutOrganizationInputSchema: z.ZodType<Prisma.IssueStatusUpsertWithWhereUniqueWithoutOrganizationInput> = z.object({
  where: z.lazy(() => IssueStatusWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => IssueStatusUpdateWithoutOrganizationInputSchema),z.lazy(() => IssueStatusUncheckedUpdateWithoutOrganizationInputSchema) ]),
  create: z.union([ z.lazy(() => IssueStatusCreateWithoutOrganizationInputSchema),z.lazy(() => IssueStatusUncheckedCreateWithoutOrganizationInputSchema) ]),
}).strict();
