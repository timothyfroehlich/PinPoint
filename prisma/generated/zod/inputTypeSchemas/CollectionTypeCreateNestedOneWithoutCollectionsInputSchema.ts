...
export const CollectionTypeCreateNestedOneWithoutCollectionsInputSchema: z.ZodType<Prisma.CollectionTypeCreateNestedOneWithoutCollectionsInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.CollectionTypeCreateNestedOneWithoutCollectionsInput>;
