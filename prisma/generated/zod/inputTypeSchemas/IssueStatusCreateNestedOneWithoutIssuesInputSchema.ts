...
export const IssueStatusCreateNestedOneWithoutIssuesInputSchema: z.ZodType<Prisma.IssueStatusCreateNestedOneWithoutIssuesInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.IssueStatusCreateNestedOneWithoutIssuesInput>;
