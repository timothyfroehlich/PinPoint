...
export const CollectionUpdateWithoutLocationInputSchema: z.ZodType<Prisma.CollectionUpdateWithoutLocationInput> = z.object({
  ...
  machines: z.lazy(() => MachineUpdateManyWithoutCollectionsNestedInputSchema).optional()
}).strict();
