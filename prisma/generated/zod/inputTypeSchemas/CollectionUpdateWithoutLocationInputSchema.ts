...
export const CollectionUpdateWithoutLocationInputSchema: z.ZodType<Prisma.CollectionUpdateWithoutLocationInput> =
  z
    .object({
      id: z
        .union([
      ...
      type: z
        .lazy(
          () =>
            CollectionTypeUpdateOneRequiredWithoutCollectionsNestedInputSchema,
        )
        .optional(),
      machines: z
    ...
    .strict() as z.ZodType<Prisma.CollectionUpdateWithoutLocationInput>;

export default CollectionUpdateWithoutLocationInputSchema;
