...
import { IssueHistoryUpdateManyWithoutIssueNestedInputSchema } from "./IssueHistoryUpdateManyWithoutIssueNestedInputSchema";
import { UpvoteUpdateManyWithoutIssueNestedInputSchema } from "./UpvoteUpdateManyWithoutIssueNestedInputSchema";

export const IssueUpdateWithoutAttachmentsInputSchema: z.ZodType<Prisma.IssueUpdateWithoutAttachmentsInput> =
  z
    .object({
      id: z
        .union([
      ...
      resolvedAt: z
        ...
        .nullable(),
      organization: z
        .lazy(() => OrganizationUpdateOneRequiredWithoutIssuesNestedInputSchema)
        .optional(),
      machine: z
        .lazy(() => MachineUpdateOneRequiredWithoutIssuesNestedInputSchema)
        .optional(),
      priority: z
        .lazy(() => PriorityUpdateOneRequiredWithoutIssuesNestedInputSchema)
        .optional(),
      status: z
        .lazy(() => IssueStatusUpdateOneRequiredWithoutIssuesNestedInputSchema)
        .optional(),
      createdBy: z
        .lazy(() => UserUpdateOneRequiredWithoutIssuesCreatedNestedInputSchema)
        .optional(),
      assignedTo: z
        .lazy(() => UserUpdateOneWithoutIssuesAssignedNestedInputSchema)
        .optional(),
      comments: z
        .lazy(() => CommentUpdateManyWithoutIssueNestedInputSchema)
        .optional(),
      history: z
        .lazy(() => IssueHistoryUpdateManyWithoutIssueNestedInputSchema)
        .optional(),
      upvotes: z
        .lazy(() => UpvoteUpdateManyWithoutIssueNestedInputSchema)
        .optional(),
    })
    .strict() as z.ZodType<Prisma.IssueUpdateWithoutAttachmentsInput>;

export default IssueUpdateWithoutAttachmentsInputSchema;
