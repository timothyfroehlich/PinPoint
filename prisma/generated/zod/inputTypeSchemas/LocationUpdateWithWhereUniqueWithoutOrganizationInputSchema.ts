...
export const LocationUpdateWithWhereUniqueWithoutOrganizationInputSchema: z.ZodType<Prisma.LocationUpdateWithWhereUniqueWithoutOrganizationInput> = z.object({
  where: z.lazy(() => LocationWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LocationUpdateWithoutOrganizationInputSchema),z.lazy(() => LocationUncheckedUpdateWithoutOrganizationInputSchema) ]),
}).strict();
