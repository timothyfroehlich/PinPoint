...
export const IssueHistoryUpdateInputSchema: z.ZodType<Prisma.IssueHistoryUpdateInput> =
  z
    .object({
      id: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.IssueHistoryUpdateInput>;

export default IssueHistoryUpdateInputSchema;
