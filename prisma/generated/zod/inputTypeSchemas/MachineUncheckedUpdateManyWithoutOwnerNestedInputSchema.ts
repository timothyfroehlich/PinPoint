...
export const MachineUncheckedUpdateManyWithoutOwnerNestedInputSchema: z.ZodType<Prisma.MachineUncheckedUpdateManyWithoutOwnerNestedInput> = z.object({
  create: z.union([ z.lazy(() => MachineCreateWithoutOwnerInputSchema),z.lazy(() => MachineCreateWithoutOwnerInputSchema).array(),z.lazy(() => MachineUncheckedCreateWithoutOwnerInputSchema),z.lazy(() => MachineUncheckedCreateWithoutOwnerInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => MachineCreateOrConnectWithoutOwnerInputSchema),z.lazy(() => MachineCreateOrConnectWithoutOwnerInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => MachineUpsertWithWhereUniqueWithoutOwnerInputSchema),z.lazy(() => MachineUpsertWithWhereUniqueWithoutOwnerInputSchema).array() ]).optional(),
  createMany: z.lazy(() => MachineCreateManyOwnerInputEnvelopeSchema).optional(),
  ...
  update: z.union([ z.lazy(() => MachineUpdateWithWhereUniqueWithoutOwnerInputSchema),z.lazy(() => MachineUpdateWithWhereUniqueWithoutOwnerInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => MachineUpdateManyWithWhereWithoutOwnerInputSchema),z.lazy(() => MachineUpdateManyWithWhereWithoutOwnerInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => MachineScalarWhereInputSchema),z.lazy(() => MachineScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default MachineUncheckedUpdateManyWithoutOwnerNestedInputSchema;
