...
export const IssueStatusWhereUniqueInputSchema: z.ZodType<Prisma.IssueStatusWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    name_organizationId: z.lazy(() => IssueStatusNameOrganizationIdCompoundUniqueInputSchema)
  }),
  z.object({
    id: z.string().cuid(),
  }),
...
.and(z.object({
  ...
  name_organizationId: z.lazy(() => IssueStatusNameOrganizationIdCompoundUniqueInputSchema).optional(),
