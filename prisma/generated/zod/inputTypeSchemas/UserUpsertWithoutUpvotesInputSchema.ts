...
export const UserUpsertWithoutUpvotesInputSchema: z.ZodType<Prisma.UserUpsertWithoutUpvotesInput> = z.object({
  update: z.union([ z.lazy(() => UserUpdateWithoutUpvotesInputSchema),z.lazy(() => UserUncheckedUpdateWithoutUpvotesInputSchema) ]),
  create: z.union([ z.lazy(() => UserCreateWithoutUpvotesInputSchema),z.lazy(() => UserUncheckedCreateWithoutUpvotesInputSchema) ]),
