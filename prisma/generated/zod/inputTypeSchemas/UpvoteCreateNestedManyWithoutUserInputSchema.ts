...
export const UpvoteCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.UpvoteCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.UpvoteCreateNestedManyWithoutUserInput>;

export default UpvoteCreateNestedManyWithoutUserInputSchema;
