...
export const IssueCreateNestedOneWithoutUpvotesInputSchema: z.ZodType<Prisma.IssueCreateNestedOneWithoutUpvotesInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.IssueCreateNestedOneWithoutUpvotesInput>;
