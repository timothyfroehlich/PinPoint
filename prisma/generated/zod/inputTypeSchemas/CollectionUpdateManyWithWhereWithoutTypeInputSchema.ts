...
export const CollectionUpdateManyWithWhereWithoutTypeInputSchema: z.ZodType<Prisma.CollectionUpdateManyWithWhereWithoutTypeInput> =
  z
    .object({
      where: z.lazy(() => CollectionScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => CollectionUpdateManyMutationInputSchema),
        z.lazy(() => CollectionUncheckedUpdateManyWithoutTypeInputSchema),
      ]),
    })
    .strict() as z.ZodType<Prisma.CollectionUpdateManyWithWhereWithoutTypeInput>;
