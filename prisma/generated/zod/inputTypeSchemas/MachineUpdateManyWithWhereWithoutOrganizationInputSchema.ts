...
export const MachineUpdateManyWithWhereWithoutOrganizationInputSchema: z.ZodType<Prisma.MachineUpdateManyWithWhereWithoutOrganizationInput> =
  z
    .object({
      where: z.lazy(() => MachineScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => MachineUpdateManyMutationInputSchema),
        z.lazy(() => MachineUncheckedUpdateManyWithoutOrganizationInputSchema),
      ]),
    })
    .strict() as z.ZodType<Prisma.MachineUpdateManyWithWhereWithoutOrganizationInput>;
