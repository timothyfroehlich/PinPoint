...
export const OrganizationCreateWithoutPrioritiesInputSchema: z.ZodType<Prisma.OrganizationCreateWithoutPrioritiesInput> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.OrganizationCreateWithoutPrioritiesInput>;
