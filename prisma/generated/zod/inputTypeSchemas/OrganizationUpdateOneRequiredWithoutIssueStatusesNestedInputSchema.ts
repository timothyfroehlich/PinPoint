...
export const OrganizationUpdateOneRequiredWithoutIssueStatusesNestedInputSchema: z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutIssueStatusesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => OrganizationUpsertWithoutIssueStatusesInputSchema)
        .optional(),
      ...
      update: z
        .union([
          z.lazy(
            () =>
              OrganizationUpdateToOneWithWhereWithoutIssueStatusesInputSchema,
          ),
    ...
    .strict() as z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutIssueStatusesNestedInput>;
