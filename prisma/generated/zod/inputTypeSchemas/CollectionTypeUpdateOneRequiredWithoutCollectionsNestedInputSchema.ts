...
export const CollectionTypeUpdateOneRequiredWithoutCollectionsNestedInputSchema: z.ZodType<Prisma.CollectionTypeUpdateOneRequiredWithoutCollectionsNestedInput> = z.object({
  ...
  upsert: z.lazy(() => CollectionTypeUpsertWithoutCollectionsInputSchema).optional(),
  connect: z.lazy(() => CollectionTypeWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => CollectionTypeUpdateToOneWithWhereWithoutCollectionsInputSchema),z.lazy(() => CollectionTypeUpdateWithoutCollectionsInputSchema),z.lazy(() => CollectionTypeUncheckedUpdateWithoutCollectionsInputSchema) ]).optional(),
}).strict();
