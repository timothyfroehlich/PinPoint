...
export const OrganizationUpdateOneRequiredWithoutRolesNestedInputSchema: z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutRolesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => OrganizationUpsertWithoutRolesInputSchema)
        .optional(),
      connect: z.lazy(() => OrganizationWhereUniqueInputSchema).optional(),
      update: z
        .union([
          z.lazy(() => OrganizationUpdateToOneWithWhereWithoutRolesInputSchema),
          z.lazy(() => OrganizationUpdateWithoutRolesInputSchema),
          z.lazy(() => OrganizationUncheckedUpdateWithoutRolesInputSchema),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutRolesNestedInput>;
