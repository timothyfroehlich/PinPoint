...
export const NestedEnumNotificationFrequencyFilterSchema: z.ZodType<Prisma.NestedEnumNotificationFrequencyFilter> =
  z
    .object({
      ...
      not: z
        .union([
          ...
          z.lazy(() => NestedEnumNotificationFrequencyFilterSchema),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.NestedEnumNotificationFrequencyFilter>;
