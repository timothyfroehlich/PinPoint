...
export const MachineMaxOrderByAggregateInputSchema: z.ZodType<Prisma.MachineMaxOrderByAggregateInput> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.MachineMaxOrderByAggregateInput>;
