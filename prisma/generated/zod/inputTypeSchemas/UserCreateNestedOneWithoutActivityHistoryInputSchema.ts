...
export const UserCreateNestedOneWithoutActivityHistoryInputSchema: z.ZodType<Prisma.UserCreateNestedOneWithoutActivityHistoryInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.UserCreateNestedOneWithoutActivityHistoryInput>;
