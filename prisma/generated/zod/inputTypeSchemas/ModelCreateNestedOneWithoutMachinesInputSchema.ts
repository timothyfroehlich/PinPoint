...
export const ModelCreateNestedOneWithoutMachinesInputSchema: z.ZodType<Prisma.ModelCreateNestedOneWithoutMachinesInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.ModelCreateNestedOneWithoutMachinesInput>;
