...
export const OrganizationUpdateToOneWithWhereWithoutIssueStatusesInputSchema: z.ZodType<Prisma.OrganizationUpdateToOneWithWhereWithoutIssueStatusesInput> = z.object({
  where: z.lazy(() => OrganizationWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => OrganizationUpdateWithoutIssueStatusesInputSchema),z.lazy(() => OrganizationUncheckedUpdateWithoutIssueStatusesInputSchema) ]),
}).strict();
