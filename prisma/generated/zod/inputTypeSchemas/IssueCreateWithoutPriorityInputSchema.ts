...
export const IssueCreateWithoutPriorityInputSchema: z.ZodType<Prisma.IssueCreateWithoutPriorityInput> =
  z
    .object({
      ...
      organization: z.lazy(
        () => OrganizationCreateNestedOneWithoutIssuesInputSchema,
      ),
      ...
      createdBy: z.lazy(
        () => UserCreateNestedOneWithoutIssuesCreatedInputSchema,
      ),
      assignedTo: z
        .lazy(() => UserCreateNestedOneWithoutIssuesAssignedInputSchema)
        .optional(),
      comments: z
        .lazy(() => CommentCreateNestedManyWithoutIssueInputSchema)
        .optional(),
      attachments: z
        .lazy(() => AttachmentCreateNestedManyWithoutIssueInputSchema)
        .optional(),
      history: z
        .lazy(() => IssueHistoryCreateNestedManyWithoutIssueInputSchema)
        .optional(),
      upvotes: z
        .lazy(() => UpvoteCreateNestedManyWithoutIssueInputSchema)
        .optional(),
    })
    .strict() as z.ZodType<Prisma.IssueCreateWithoutPriorityInput>;

export default IssueCreateWithoutPriorityInputSchema;
