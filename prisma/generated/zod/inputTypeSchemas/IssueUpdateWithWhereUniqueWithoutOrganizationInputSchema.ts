...
export const IssueUpdateWithWhereUniqueWithoutOrganizationInputSchema: z.ZodType<Prisma.IssueUpdateWithWhereUniqueWithoutOrganizationInput> = z.object({
  where: z.lazy(() => IssueWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => IssueUpdateWithoutOrganizationInputSchema),z.lazy(() => IssueUncheckedUpdateWithoutOrganizationInputSchema) ]),
}).strict();
