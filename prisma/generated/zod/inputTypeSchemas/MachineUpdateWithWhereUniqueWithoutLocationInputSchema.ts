...
export const MachineUpdateWithWhereUniqueWithoutLocationInputSchema: z.ZodType<Prisma.MachineUpdateWithWhereUniqueWithoutLocationInput> =
  z
    .object({
      where: z.lazy(() => MachineWhereUniqueInputSchema),
      data: z.union([
        z.lazy(() => MachineUpdateWithoutLocationInputSchema),
        z.lazy(() => MachineUncheckedUpdateWithoutLocationInputSchema),
      ]),
    })
    .strict() as z.ZodType<Prisma.MachineUpdateWithWhereUniqueWithoutLocationInput>;
