...
export const UserUpsertWithoutActivityHistoryInputSchema: z.ZodType<Prisma.UserUpsertWithoutActivityHistoryInput> = z.object({
  update: z.union([ z.lazy(() => UserUpdateWithoutActivityHistoryInputSchema),z.lazy(() => UserUncheckedUpdateWithoutActivityHistoryInputSchema) ]),
  create: z.union([ z.lazy(() => UserCreateWithoutActivityHistoryInputSchema),z.lazy(() => UserUncheckedCreateWithoutActivityHistoryInputSchema) ]),
