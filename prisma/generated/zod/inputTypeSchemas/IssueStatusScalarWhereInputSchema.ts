...
export const IssueStatusScalarWhereInputSchema: z.ZodType<Prisma.IssueStatusScalarWhereInput> =
  z
    .object({
      AND: z
        .union([
        ...
        .optional(),
      OR: z
        .lazy(() => IssueStatusScalarWhereInputSchema)
        .array()
        .optional(),
      NOT: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.IssueStatusScalarWhereInput>;
