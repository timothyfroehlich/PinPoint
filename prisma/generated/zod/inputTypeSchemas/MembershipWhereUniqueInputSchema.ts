...
export const MembershipWhereUniqueInputSchema: z.ZodType<Prisma.MembershipWhereUniqueInput> =
  z
    .union([
      z.object({
        id: z.string().cuid(),
        userId_organizationId: z.lazy(
          () => MembershipUserIdOrganizationIdCompoundUniqueInputSchema,
        ),
      }),
      z.object({
        id: z.string().cuid(),
      ...
      z
        .object({
          ...
          userId_organizationId: z
            .lazy(() => MembershipUserIdOrganizationIdCompoundUniqueInputSchema)
            .optional(),
          AND: z
            .union([
        ...
        .strict(),
    ) as z.ZodType<Prisma.MembershipWhereUniqueInput>;
