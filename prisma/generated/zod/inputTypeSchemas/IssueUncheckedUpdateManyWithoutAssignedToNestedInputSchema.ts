...
export const IssueUncheckedUpdateManyWithoutAssignedToNestedInputSchema: z.ZodType<Prisma.IssueUncheckedUpdateManyWithoutAssignedToNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => IssueUpsertWithWhereUniqueWithoutAssignedToInputSchema),
          z
            .lazy(() => IssueUpsertWithWhereUniqueWithoutAssignedToInputSchema)
            .array(),
        ])
        .optional(),
      createMany: z
      ...
      update: z
        .union([
          z.lazy(() => IssueUpdateWithWhereUniqueWithoutAssignedToInputSchema),
          z
            .lazy(() => IssueUpdateWithWhereUniqueWithoutAssignedToInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => IssueUpdateManyWithWhereWithoutAssignedToInputSchema),
          z
            .lazy(() => IssueUpdateManyWithWhereWithoutAssignedToInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
    ...
    .strict() as z.ZodType<Prisma.IssueUncheckedUpdateManyWithoutAssignedToNestedInput>;

export default IssueUncheckedUpdateManyWithoutAssignedToNestedInputSchema;
