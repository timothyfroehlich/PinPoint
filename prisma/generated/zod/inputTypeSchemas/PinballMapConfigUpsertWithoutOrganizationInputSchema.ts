...
export const PinballMapConfigUpsertWithoutOrganizationInputSchema: z.ZodType<Prisma.PinballMapConfigUpsertWithoutOrganizationInput> = z.object({
  update: z.union([ z.lazy(() => PinballMapConfigUpdateWithoutOrganizationInputSchema),z.lazy(() => PinballMapConfigUncheckedUpdateWithoutOrganizationInputSchema) ]),
  create: z.union([ z.lazy(() => PinballMapConfigCreateWithoutOrganizationInputSchema),z.lazy(() => PinballMapConfigUncheckedCreateWithoutOrganizationInputSchema) ]),
