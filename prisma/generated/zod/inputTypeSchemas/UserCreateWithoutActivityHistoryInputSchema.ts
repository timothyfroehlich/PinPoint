...
export const UserCreateWithoutActivityHistoryInputSchema: z.ZodType<Prisma.UserCreateWithoutActivityHistoryInput> =
  z
    .object({
      ...
      comments: z
        ...
        .optional(),
      deletedComments: z
        .lazy(() => CommentCreateNestedManyWithoutDeleterInputSchema)
        .optional(),
      upvotes: z
    ...
    .strict() as z.ZodType<Prisma.UserCreateWithoutActivityHistoryInput>;

export default UserCreateWithoutActivityHistoryInputSchema;
