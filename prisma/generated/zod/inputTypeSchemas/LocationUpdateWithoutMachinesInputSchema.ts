...
export const LocationUpdateWithoutMachinesInputSchema: z.ZodType<Prisma.LocationUpdateWithoutMachinesInput> = z.object({
  ...
  collections: z.lazy(() => CollectionUpdateManyWithoutLocationNestedInputSchema).optional()
}).strict();

export default LocationUpdateWithoutMachinesInputSchema;
