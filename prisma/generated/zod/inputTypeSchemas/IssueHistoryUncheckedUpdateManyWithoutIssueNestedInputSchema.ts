...
export const IssueHistoryUncheckedUpdateManyWithoutIssueNestedInputSchema: z.ZodType<Prisma.IssueHistoryUncheckedUpdateManyWithoutIssueNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => IssueHistoryUpsertWithWhereUniqueWithoutIssueInputSchema,
          ),
          z
            .lazy(
              () => IssueHistoryUpsertWithWhereUniqueWithoutIssueInputSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => IssueHistoryUpdateWithWhereUniqueWithoutIssueInputSchema,
          ),
          z
            .lazy(
              () => IssueHistoryUpdateWithWhereUniqueWithoutIssueInputSchema,
      ...
      updateMany: z
        .union([
          z.lazy(() => IssueHistoryUpdateManyWithWhereWithoutIssueInputSchema),
          z
            .lazy(() => IssueHistoryUpdateManyWithWhereWithoutIssueInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
    ...
    .strict() as z.ZodType<Prisma.IssueHistoryUncheckedUpdateManyWithoutIssueNestedInput>;

export default IssueHistoryUncheckedUpdateManyWithoutIssueNestedInputSchema;
