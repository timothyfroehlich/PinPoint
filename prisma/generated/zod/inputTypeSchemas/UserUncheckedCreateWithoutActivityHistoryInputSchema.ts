...
export const UserUncheckedCreateWithoutActivityHistoryInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutActivityHistoryInput> =
  z
    .object({
      ...
      sessions: z
        ...
        .optional(),
      memberships: z
        .lazy(() => MembershipUncheckedCreateNestedManyWithoutUserInputSchema)
        .optional(),
      ownedMachines: z
        .lazy(() => MachineUncheckedCreateNestedManyWithoutOwnerInputSchema)
        .optional(),
      issuesCreated: z
        .lazy(() => IssueUncheckedCreateNestedManyWithoutCreatedByInputSchema)
        .optional(),
      issuesAssigned: z
        .lazy(() => IssueUncheckedCreateNestedManyWithoutAssignedToInputSchema)
        .optional(),
      comments: z
        .lazy(() => CommentUncheckedCreateNestedManyWithoutAuthorInputSchema)
        .optional(),
      deletedComments: z
        .lazy(() => CommentUncheckedCreateNestedManyWithoutDeleterInputSchema)
        .optional(),
      upvotes: z
        .lazy(() => UpvoteUncheckedCreateNestedManyWithoutUserInputSchema)
        .optional(),
      notifications: z
        .lazy(() => NotificationUncheckedCreateNestedManyWithoutUserInputSchema)
        .optional(),
    })
    .strict() as z.ZodType<Prisma.UserUncheckedCreateWithoutActivityHistoryInput>;

export default UserUncheckedCreateWithoutActivityHistoryInputSchema;
