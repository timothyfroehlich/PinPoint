...
export const MembershipUpdateManyWithWhereWithoutOrganizationInputSchema: z.ZodType<Prisma.MembershipUpdateManyWithWhereWithoutOrganizationInput> =
  z
    .object({
      ...
      data: z.union([
        ...
        z.lazy(
          () => MembershipUncheckedUpdateManyWithoutOrganizationInputSchema,
        ),
      ]),
    })
    .strict() as z.ZodType<Prisma.MembershipUpdateManyWithWhereWithoutOrganizationInput>;
