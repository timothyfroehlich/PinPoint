...
export const IssueCreateNestedManyWithoutCreatedByInputSchema: z.ZodType<Prisma.IssueCreateNestedManyWithoutCreatedByInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.IssueCreateNestedManyWithoutCreatedByInput>;

export default IssueCreateNestedManyWithoutCreatedByInputSchema;
