...
export const OrganizationUpdateOneRequiredWithoutPinballMapConfigNestedInputSchema: z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutPinballMapConfigNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        .lazy(
          () => OrganizationCreateOrConnectWithoutPinballMapConfigInputSchema,
        )
        .optional(),
      upsert: z
        .lazy(() => OrganizationUpsertWithoutPinballMapConfigInputSchema)
        .optional(),
      ...
      update: z
        .union([
          z.lazy(
            () =>
              OrganizationUpdateToOneWithWhereWithoutPinballMapConfigInputSchema,
          ),
    ...
    .strict() as z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutPinballMapConfigNestedInput>;
