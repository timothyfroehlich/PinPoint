...
export const IssueCreateOrConnectWithoutStatusInputSchema: z.ZodType<Prisma.IssueCreateOrConnectWithoutStatusInput> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.IssueCreateOrConnectWithoutStatusInput>;
