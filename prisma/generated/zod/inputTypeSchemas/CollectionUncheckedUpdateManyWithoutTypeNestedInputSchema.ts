...
export const CollectionUncheckedUpdateManyWithoutTypeNestedInputSchema: z.ZodType<Prisma.CollectionUncheckedUpdateManyWithoutTypeNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => CollectionUpsertWithWhereUniqueWithoutTypeInputSchema),
          z
            .lazy(() => CollectionUpsertWithWhereUniqueWithoutTypeInputSchema)
            .array(),
        ])
        .optional(),
      createMany: z
      ...
      update: z
        .union([
          z.lazy(() => CollectionUpdateWithWhereUniqueWithoutTypeInputSchema),
          z
            .lazy(() => CollectionUpdateWithWhereUniqueWithoutTypeInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => CollectionUpdateManyWithWhereWithoutTypeInputSchema),
          z
            .lazy(() => CollectionUpdateManyWithWhereWithoutTypeInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
    ...
    .strict() as z.ZodType<Prisma.CollectionUncheckedUpdateManyWithoutTypeNestedInput>;

export default CollectionUncheckedUpdateManyWithoutTypeNestedInputSchema;
