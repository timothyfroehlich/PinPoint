...
export const CommentUncheckedUpdateManyWithoutDeleterNestedInputSchema: z.ZodType<Prisma.CommentUncheckedUpdateManyWithoutDeleterNestedInput> = z.object({
  create: z.union([ z.lazy(() => CommentCreateWithoutDeleterInputSchema),z.lazy(() => CommentCreateWithoutDeleterInputSchema).array(),z.lazy(() => CommentUncheckedCreateWithoutDeleterInputSchema),z.lazy(() => CommentUncheckedCreateWithoutDeleterInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => CommentCreateOrConnectWithoutDeleterInputSchema),z.lazy(() => CommentCreateOrConnectWithoutDeleterInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => CommentUpsertWithWhereUniqueWithoutDeleterInputSchema),z.lazy(() => CommentUpsertWithWhereUniqueWithoutDeleterInputSchema).array() ]).optional(),
  createMany: z.lazy(() => CommentCreateManyDeleterInputEnvelopeSchema).optional(),
  ...
  update: z.union([ z.lazy(() => CommentUpdateWithWhereUniqueWithoutDeleterInputSchema),z.lazy(() => CommentUpdateWithWhereUniqueWithoutDeleterInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => CommentUpdateManyWithWhereWithoutDeleterInputSchema),z.lazy(() => CommentUpdateManyWithWhereWithoutDeleterInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => CommentScalarWhereInputSchema),z.lazy(() => CommentScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default CommentUncheckedUpdateManyWithoutDeleterNestedInputSchema;
