...
export const CollectionUpdateManyWithoutMachinesNestedInputSchema: z.ZodType<Prisma.CollectionUpdateManyWithoutMachinesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => CollectionUpsertWithWhereUniqueWithoutMachinesInputSchema,
          ),
          z
            .lazy(
              () => CollectionUpsertWithWhereUniqueWithoutMachinesInputSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => CollectionUpdateWithWhereUniqueWithoutMachinesInputSchema,
          ),
          z
            .lazy(
              () => CollectionUpdateWithWhereUniqueWithoutMachinesInputSchema,
      ...
      updateMany: z
        .union([
          z.lazy(() => CollectionUpdateManyWithWhereWithoutMachinesInputSchema),
          z
            .lazy(() => CollectionUpdateManyWithWhereWithoutMachinesInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
    ...
    .strict() as z.ZodType<Prisma.CollectionUpdateManyWithoutMachinesNestedInput>;

export default CollectionUpdateManyWithoutMachinesNestedInputSchema;
