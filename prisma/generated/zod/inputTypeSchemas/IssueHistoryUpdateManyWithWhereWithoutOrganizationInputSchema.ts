...
export const IssueHistoryUpdateManyWithWhereWithoutOrganizationInputSchema: z.ZodType<Prisma.IssueHistoryUpdateManyWithWhereWithoutOrganizationInput> =
  z
    .object({
      ...
      data: z.union([
        ...
        z.lazy(
          () => IssueHistoryUncheckedUpdateManyWithoutOrganizationInputSchema,
        ),
      ]),
    })
    .strict() as z.ZodType<Prisma.IssueHistoryUpdateManyWithWhereWithoutOrganizationInput>;
