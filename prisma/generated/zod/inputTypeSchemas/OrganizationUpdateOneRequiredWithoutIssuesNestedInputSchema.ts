...
export const OrganizationUpdateOneRequiredWithoutIssuesNestedInputSchema: z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutIssuesNestedInput> = z.object({
  ...
  upsert: z.lazy(() => OrganizationUpsertWithoutIssuesInputSchema).optional(),
  connect: z.lazy(() => OrganizationWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => OrganizationUpdateToOneWithWhereWithoutIssuesInputSchema),z.lazy(() => OrganizationUpdateWithoutIssuesInputSchema),z.lazy(() => OrganizationUncheckedUpdateWithoutIssuesInputSchema) ]).optional(),
}).strict();
