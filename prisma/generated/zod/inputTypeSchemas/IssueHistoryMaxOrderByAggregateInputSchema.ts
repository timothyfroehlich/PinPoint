...
export const IssueHistoryMaxOrderByAggregateInputSchema: z.ZodType<Prisma.IssueHistoryMaxOrderByAggregateInput> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.IssueHistoryMaxOrderByAggregateInput>;
