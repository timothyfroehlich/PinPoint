...
export const PriorityWhereUniqueInputSchema: z.ZodType<Prisma.PriorityWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    name_organizationId: z.lazy(() => PriorityNameOrganizationIdCompoundUniqueInputSchema)
  }),
  z.object({
    id: z.string().cuid(),
  }),
...
.and(z.object({
  ...
  name_organizationId: z.lazy(() => PriorityNameOrganizationIdCompoundUniqueInputSchema).optional(),
