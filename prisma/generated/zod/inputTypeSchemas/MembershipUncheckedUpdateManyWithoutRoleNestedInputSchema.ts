...
export const MembershipUncheckedUpdateManyWithoutRoleNestedInputSchema: z.ZodType<Prisma.MembershipUncheckedUpdateManyWithoutRoleNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => MembershipUpsertWithWhereUniqueWithoutRoleInputSchema),
          z
            .lazy(() => MembershipUpsertWithWhereUniqueWithoutRoleInputSchema)
            .array(),
        ])
        .optional(),
      createMany: z
      ...
      update: z
        .union([
          z.lazy(() => MembershipUpdateWithWhereUniqueWithoutRoleInputSchema),
          z
            .lazy(() => MembershipUpdateWithWhereUniqueWithoutRoleInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => MembershipUpdateManyWithWhereWithoutRoleInputSchema),
          z
            .lazy(() => MembershipUpdateManyWithWhereWithoutRoleInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
    ...
    .strict() as z.ZodType<Prisma.MembershipUncheckedUpdateManyWithoutRoleNestedInput>;

export default MembershipUncheckedUpdateManyWithoutRoleNestedInputSchema;
