...
export const IssueStatusUpdateInputSchema: z.ZodType<Prisma.IssueStatusUpdateInput> =
  z
    .object({
      id: z
        .union([
      ...
      organization: z
        ...
        .optional(),
      issues: z
        .lazy(() => IssueUpdateManyWithoutStatusNestedInputSchema)
        .optional(),
    })
    .strict() as z.ZodType<Prisma.IssueStatusUpdateInput>;
