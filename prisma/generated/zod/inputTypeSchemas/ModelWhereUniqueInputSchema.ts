...
export const ModelWhereUniqueInputSchema: z.ZodType<Prisma.ModelWhereUniqueInput> =
  z
    .union([
      z.object({
        id: z.string().cuid(),
    ...
    .and(
      z
        .object({
          ...
          AND: z
            .union([
              ...
              z.lazy(() => ModelWhereInputSchema).array(),
            ])
            .optional(),
          OR: z
            .lazy(() => ModelWhereInputSchema)
            .array()
            .optional(),
          NOT: z
            .union([
        ...
        .strict(),
    ) as z.ZodType<Prisma.ModelWhereUniqueInput>;
