...
export const CommentUpdateManyWithWhereWithoutDeleterInputSchema: z.ZodType<Prisma.CommentUpdateManyWithWhereWithoutDeleterInput> =
  z
    .object({
      where: z.lazy(() => CommentScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => CommentUpdateManyMutationInputSchema),
        z.lazy(() => CommentUncheckedUpdateManyWithoutDeleterInputSchema),
      ]),
    })
    .strict() as z.ZodType<Prisma.CommentUpdateManyWithWhereWithoutDeleterInput>;
