...
export const CollectionTypeWhereUniqueInputSchema: z.ZodType<Prisma.CollectionTypeWhereUniqueInput> =
  z
    .union([
      z.object({
        id: z.string().cuid(),
        name_organizationId: z.lazy(
          () => CollectionTypeNameOrganizationIdCompoundUniqueInputSchema,
        ),
      }),
      z.object({
        id: z.string().cuid(),
    ...
    .and(
      z
        ...
        .strict(),
    ) as z.ZodType<Prisma.CollectionTypeWhereUniqueInput>;
