...
export const UpvoteUpdateWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.UpvoteUpdateWithWhereUniqueWithoutUserInput> =
  z
    .object({
      where: z.lazy(() => UpvoteWhereUniqueInputSchema),
      data: z.union([
        z.lazy(() => UpvoteUpdateWithoutUserInputSchema),
        z.lazy(() => UpvoteUncheckedUpdateWithoutUserInputSchema),
      ]),
    })
    .strict() as z.ZodType<Prisma.UpvoteUpdateWithWhereUniqueWithoutUserInput>;
