...
export const UpvoteUpdateManyWithoutIssueNestedInputSchema: z.ZodType<Prisma.UpvoteUpdateManyWithoutIssueNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => UpvoteUpsertWithWhereUniqueWithoutIssueInputSchema),
          z
            .lazy(() => UpvoteUpsertWithWhereUniqueWithoutIssueInputSchema)
            .array(),
        ])
        .optional(),
      createMany: z
      ...
      update: z
        .union([
          z.lazy(() => UpvoteUpdateWithWhereUniqueWithoutIssueInputSchema),
          z
            .lazy(() => UpvoteUpdateWithWhereUniqueWithoutIssueInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => UpvoteUpdateManyWithWhereWithoutIssueInputSchema),
          z
            .lazy(() => UpvoteUpdateManyWithWhereWithoutIssueInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
    ...
    .strict() as z.ZodType<Prisma.UpvoteUpdateManyWithoutIssueNestedInput>;

export default UpvoteUpdateManyWithoutIssueNestedInputSchema;
