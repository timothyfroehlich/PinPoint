...
export const IssueUpdateWithWhereUniqueWithoutStatusInputSchema: z.ZodType<Prisma.IssueUpdateWithWhereUniqueWithoutStatusInput> = z.object({
  where: z.lazy(() => IssueWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => IssueUpdateWithoutStatusInputSchema),z.lazy(() => IssueUncheckedUpdateWithoutStatusInputSchema) ]),
}).strict();
