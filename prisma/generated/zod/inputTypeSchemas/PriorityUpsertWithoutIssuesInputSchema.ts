...
export const PriorityUpsertWithoutIssuesInputSchema: z.ZodType<Prisma.PriorityUpsertWithoutIssuesInput> = z.object({
  update: z.union([ z.lazy(() => PriorityUpdateWithoutIssuesInputSchema),z.lazy(() => PriorityUncheckedUpdateWithoutIssuesInputSchema) ]),
  create: z.union([ z.lazy(() => PriorityCreateWithoutIssuesInputSchema),z.lazy(() => PriorityUncheckedCreateWithoutIssuesInputSchema) ]),
