...
export const NestedEnumStatusCategoryFilterSchema: z.ZodType<Prisma.NestedEnumStatusCategoryFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => StatusCategorySchema),z.lazy(() => NestedEnumStatusCategoryFilterSchema) ]).optional(),
}).strict();
