...
export const IssueHistoryUpdateWithWhereUniqueWithoutOrganizationInputSchema: z.ZodType<Prisma.IssueHistoryUpdateWithWhereUniqueWithoutOrganizationInput> = z.object({
  where: z.lazy(() => IssueHistoryWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => IssueHistoryUpdateWithoutOrganizationInputSchema),z.lazy(() => IssueHistoryUncheckedUpdateWithoutOrganizationInputSchema) ]),
}).strict();
