...
export const ModelMaxOrderByAggregateInputSchema: z.ZodType<Prisma.ModelMaxOrderByAggregateInput> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.ModelMaxOrderByAggregateInput>;

export default ModelMaxOrderByAggregateInputSchema;
