...
export const RoleCreateNestedOneWithoutMembershipsInputSchema: z.ZodType<Prisma.RoleCreateNestedOneWithoutMembershipsInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.RoleCreateNestedOneWithoutMembershipsInput>;
