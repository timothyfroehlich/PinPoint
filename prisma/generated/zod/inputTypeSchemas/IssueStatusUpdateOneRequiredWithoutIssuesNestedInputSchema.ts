...
export const IssueStatusUpdateOneRequiredWithoutIssuesNestedInputSchema: z.ZodType<Prisma.IssueStatusUpdateOneRequiredWithoutIssuesNestedInput> = z.object({
  ...
  upsert: z.lazy(() => IssueStatusUpsertWithoutIssuesInputSchema).optional(),
  connect: z.lazy(() => IssueStatusWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => IssueStatusUpdateToOneWithWhereWithoutIssuesInputSchema),z.lazy(() => IssueStatusUpdateWithoutIssuesInputSchema),z.lazy(() => IssueStatusUncheckedUpdateWithoutIssuesInputSchema) ]).optional(),
}).strict();
