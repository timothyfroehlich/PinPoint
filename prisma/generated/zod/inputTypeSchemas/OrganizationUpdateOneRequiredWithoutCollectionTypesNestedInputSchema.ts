...
export const OrganizationUpdateOneRequiredWithoutCollectionTypesNestedInputSchema: z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutCollectionTypesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => OrganizationUpsertWithoutCollectionTypesInputSchema)
        .optional(),
      ...
      update: z
        .union([
          z.lazy(
            () =>
              OrganizationUpdateToOneWithWhereWithoutCollectionTypesInputSchema,
          ),
    ...
    .strict() as z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutCollectionTypesNestedInput>;
