...
export const AttachmentUpdateManyWithoutOrganizationNestedInputSchema: z.ZodType<Prisma.AttachmentUpdateManyWithoutOrganizationNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => AttachmentUpsertWithWhereUniqueWithoutOrganizationInputSchema),z.lazy(() => AttachmentUpsertWithWhereUniqueWithoutOrganizationInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => AttachmentUpdateWithWhereUniqueWithoutOrganizationInputSchema),z.lazy(() => AttachmentUpdateWithWhereUniqueWithoutOrganizationInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => AttachmentUpdateManyWithWhereWithoutOrganizationInputSchema),z.lazy(() => AttachmentUpdateManyWithWhereWithoutOrganizationInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => AttachmentScalarWhereInputSchema),z.lazy(() => AttachmentScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default AttachmentUpdateManyWithoutOrganizationNestedInputSchema;
