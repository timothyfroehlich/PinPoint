...
export const CollectionTypeUpdateManyWithoutOrganizationNestedInputSchema: z.ZodType<Prisma.CollectionTypeUpdateManyWithoutOrganizationNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => CollectionTypeUpsertWithWhereUniqueWithoutOrganizationInputSchema),z.lazy(() => CollectionTypeUpsertWithWhereUniqueWithoutOrganizationInputSchema).array() ]).optional(),
  createMany: z.lazy(() => CollectionTypeCreateManyOrganizationInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => CollectionTypeWhereUniqueInputSchema),z.lazy(() => CollectionTypeWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => CollectionTypeWhereUniqueInputSchema),z.lazy(() => CollectionTypeWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => CollectionTypeWhereUniqueInputSchema),z.lazy(() => CollectionTypeWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => CollectionTypeWhereUniqueInputSchema),z.lazy(() => CollectionTypeWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => CollectionTypeUpdateWithWhereUniqueWithoutOrganizationInputSchema),z.lazy(() => CollectionTypeUpdateWithWhereUniqueWithoutOrganizationInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => CollectionTypeUpdateManyWithWhereWithoutOrganizationInputSchema),z.lazy(() => CollectionTypeUpdateManyWithWhereWithoutOrganizationInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => CollectionTypeScalarWhereInputSchema),z.lazy(() => CollectionTypeScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default CollectionTypeUpdateManyWithoutOrganizationNestedInputSchema;
