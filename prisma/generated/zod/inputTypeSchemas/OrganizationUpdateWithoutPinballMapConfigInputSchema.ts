...
import { PriorityUpdateManyWithoutOrganizationNestedInputSchema } from "./PriorityUpdateManyWithoutOrganizationNestedInputSchema";
...
export const OrganizationUpdateWithoutPinballMapConfigInputSchema: z.ZodType<Prisma.OrganizationUpdateWithoutPinballMapConfigInput> =
  z
    .object({
      id: z
        .union([
      ...
      updatedAt: z
        ...
        .optional(),
      memberships: z
        .lazy(() => MembershipUpdateManyWithoutOrganizationNestedInputSchema)
        .optional(),
      locations: z
        .lazy(() => LocationUpdateManyWithoutOrganizationNestedInputSchema)
        .optional(),
      roles: z
        .lazy(() => RoleUpdateManyWithoutOrganizationNestedInputSchema)
        .optional(),
      machines: z
        .lazy(() => MachineUpdateManyWithoutOrganizationNestedInputSchema)
        .optional(),
      issues: z
        .lazy(() => IssueUpdateManyWithoutOrganizationNestedInputSchema)
        .optional(),
      priorities: z
        .lazy(() => PriorityUpdateManyWithoutOrganizationNestedInputSchema)
        .optional(),
      issueStatuses: z
        .lazy(() => IssueStatusUpdateManyWithoutOrganizationNestedInputSchema)
        .optional(),
      collectionTypes: z
        .lazy(
          () => CollectionTypeUpdateManyWithoutOrganizationNestedInputSchema,
        )
        .optional(),
      issueHistory: z
        .lazy(() => IssueHistoryUpdateManyWithoutOrganizationNestedInputSchema)
        .optional(),
      attachments: z
        .lazy(() => AttachmentUpdateManyWithoutOrganizationNestedInputSchema)
        .optional(),
    })
    .strict() as z.ZodType<Prisma.OrganizationUpdateWithoutPinballMapConfigInput>;

export default OrganizationUpdateWithoutPinballMapConfigInputSchema;
