...
export const UserUpsertWithoutIssuesCreatedInputSchema: z.ZodType<Prisma.UserUpsertWithoutIssuesCreatedInput> =
  z
    .object({
      update: z.union([
    ...
    .strict() as z.ZodType<Prisma.UserUpsertWithoutIssuesCreatedInput>;
