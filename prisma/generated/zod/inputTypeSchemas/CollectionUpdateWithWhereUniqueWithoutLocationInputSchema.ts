...
export const CollectionUpdateWithWhereUniqueWithoutLocationInputSchema: z.ZodType<Prisma.CollectionUpdateWithWhereUniqueWithoutLocationInput> = z.object({
  where: z.lazy(() => CollectionWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => CollectionUpdateWithoutLocationInputSchema),z.lazy(() => CollectionUncheckedUpdateWithoutLocationInputSchema) ]),
}).strict();
