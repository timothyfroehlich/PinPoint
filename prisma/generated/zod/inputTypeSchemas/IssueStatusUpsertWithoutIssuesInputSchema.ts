...
export const IssueStatusUpsertWithoutIssuesInputSchema: z.ZodType<Prisma.IssueStatusUpsertWithoutIssuesInput> =
  z
    .object({
      update: z.union([
    ...
    .strict() as z.ZodType<Prisma.IssueStatusUpsertWithoutIssuesInput>;
