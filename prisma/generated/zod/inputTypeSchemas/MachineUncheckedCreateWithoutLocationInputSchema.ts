...
export const MachineUncheckedCreateWithoutLocationInputSchema: z.ZodType<Prisma.MachineUncheckedCreateWithoutLocationInput> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.MachineUncheckedCreateWithoutLocationInput>;
