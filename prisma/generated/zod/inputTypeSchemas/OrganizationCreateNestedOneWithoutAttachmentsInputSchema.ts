...
export const OrganizationCreateNestedOneWithoutAttachmentsInputSchema: z.ZodType<Prisma.OrganizationCreateNestedOneWithoutAttachmentsInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.OrganizationCreateNestedOneWithoutAttachmentsInput>;
