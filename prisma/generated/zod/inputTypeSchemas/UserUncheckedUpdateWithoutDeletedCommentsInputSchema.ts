...
import { IssueUncheckedUpdateManyWithoutCreatedByNestedInputSchema } from './IssueUncheckedUpdateManyWithoutCreatedByNestedInputSchema';
...
export const UserUncheckedUpdateWithoutDeletedCommentsInputSchema: z.ZodType<Prisma.UserUncheckedUpdateWithoutDeletedCommentsInput> = z.object({
  ...
  ownedMachines: z.lazy(() => MachineUncheckedUpdateManyWithoutOwnerNestedInputSchema).optional(),
  issuesCreated: z.lazy(() => IssueUncheckedUpdateManyWithoutCreatedByNestedInputSchema).optional(),
  issuesAssigned: z.lazy(() => IssueUncheckedUpdateManyWithoutAssignedToNestedInputSchema).optional(),
  comments: z.lazy(() => CommentUncheckedUpdateManyWithoutAuthorNestedInputSchema).optional(),
  upvotes: z.lazy(() => UpvoteUncheckedUpdateManyWithoutUserNestedInputSchema).optional(),
  activityHistory: z.lazy(() => IssueHistoryUncheckedUpdateManyWithoutActorNestedInputSchema).optional(),
  notifications: z.lazy(() => NotificationUncheckedUpdateManyWithoutUserNestedInputSchema).optional()
}).strict();

export default UserUncheckedUpdateWithoutDeletedCommentsInputSchema;
