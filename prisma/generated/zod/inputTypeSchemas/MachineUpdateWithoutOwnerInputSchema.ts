...
export const MachineUpdateWithoutOwnerInputSchema: z.ZodType<Prisma.MachineUpdateWithoutOwnerInput> =
  z
    .object({
      id: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.MachineUpdateWithoutOwnerInput>;
