...
export const MachineUncheckedUpdateManyWithoutLocationNestedInputSchema: z.ZodType<Prisma.MachineUncheckedUpdateManyWithoutLocationNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => MachineCreateWithoutLocationInputSchema),
          z.lazy(() => MachineCreateWithoutLocationInputSchema).array(),
          z.lazy(() => MachineUncheckedCreateWithoutLocationInputSchema),
          z
            .lazy(() => MachineUncheckedCreateWithoutLocationInputSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => MachineCreateOrConnectWithoutLocationInputSchema),
          z
            .lazy(() => MachineCreateOrConnectWithoutLocationInputSchema)
            .array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(() => MachineUpsertWithWhereUniqueWithoutLocationInputSchema),
          z
            .lazy(() => MachineUpsertWithWhereUniqueWithoutLocationInputSchema)
            .array(),
        ])
        .optional(),
      createMany: z
        .lazy(() => MachineCreateManyLocationInputEnvelopeSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => MachineUpdateWithWhereUniqueWithoutLocationInputSchema),
          z
            .lazy(() => MachineUpdateWithWhereUniqueWithoutLocationInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => MachineUpdateManyWithWhereWithoutLocationInputSchema),
          z
            .lazy(() => MachineUpdateManyWithWhereWithoutLocationInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
    ...
    .strict() as z.ZodType<Prisma.MachineUncheckedUpdateManyWithoutLocationNestedInput>;

export default MachineUncheckedUpdateManyWithoutLocationNestedInputSchema;
