...
export const PriorityUncheckedUpdateManyWithoutOrganizationNestedInputSchema: z.ZodType<Prisma.PriorityUncheckedUpdateManyWithoutOrganizationNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => PriorityUpsertWithWhereUniqueWithoutOrganizationInputSchema,
          ),
          z
            .lazy(
              () => PriorityUpsertWithWhereUniqueWithoutOrganizationInputSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => PriorityUpdateWithWhereUniqueWithoutOrganizationInputSchema,
          ),
          z
            .lazy(
              () => PriorityUpdateWithWhereUniqueWithoutOrganizationInputSchema,
      ...
      updateMany: z
        .union([
          z.lazy(
            () => PriorityUpdateManyWithWhereWithoutOrganizationInputSchema,
          ),
          z
            .lazy(
              () => PriorityUpdateManyWithWhereWithoutOrganizationInputSchema,
      ...
      deleteMany: z
        .union([
          z.lazy(() => PriorityScalarWhereInputSchema),
          z.lazy(() => PriorityScalarWhereInputSchema).array(),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.PriorityUncheckedUpdateManyWithoutOrganizationNestedInput>;

export default PriorityUncheckedUpdateManyWithoutOrganizationNestedInputSchema;
