...
export const IssueCreateNestedOneWithoutAttachmentsInputSchema: z.ZodType<Prisma.IssueCreateNestedOneWithoutAttachmentsInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.IssueCreateNestedOneWithoutAttachmentsInput>;
