...
export const OrganizationCreateNestedOneWithoutPinballMapConfigInputSchema: z.ZodType<Prisma.OrganizationCreateNestedOneWithoutPinballMapConfigInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.OrganizationCreateNestedOneWithoutPinballMapConfigInput>;
