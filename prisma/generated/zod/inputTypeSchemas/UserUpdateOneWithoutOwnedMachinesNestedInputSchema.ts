...
export const UserUpdateOneWithoutOwnedMachinesNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutOwnedMachinesNestedInput> =
  z
    .object({
      create: z
        .union([
        ...
        .optional(),
      connectOrCreate: z
        .lazy(() => UserCreateOrConnectWithoutOwnedMachinesInputSchema)
        .optional(),
      upsert: z
        .lazy(() => UserUpsertWithoutOwnedMachinesInputSchema)
        .optional(),
      disconnect: z
      ...
      update: z
        .union([
          z.lazy(() => UserUpdateToOneWithWhereWithoutOwnedMachinesInputSchema),
          z.lazy(() => UserUpdateWithoutOwnedMachinesInputSchema),
          z.lazy(() => UserUncheckedUpdateWithoutOwnedMachinesInputSchema),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.UserUpdateOneWithoutOwnedMachinesNestedInput>;
