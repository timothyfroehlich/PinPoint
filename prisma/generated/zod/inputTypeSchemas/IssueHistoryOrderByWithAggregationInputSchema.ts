...
export const IssueHistoryOrderByWithAggregationInputSchema: z.ZodType<Prisma.IssueHistoryOrderByWithAggregationInput> =
  z
    .object({
      ...
      _count: z
        .lazy(() => IssueHistoryCountOrderByAggregateInputSchema)
        .optional(),
    ...
    .strict() as z.ZodType<Prisma.IssueHistoryOrderByWithAggregationInput>;
