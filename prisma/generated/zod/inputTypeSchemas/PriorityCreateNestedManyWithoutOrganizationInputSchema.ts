...
export const PriorityCreateNestedManyWithoutOrganizationInputSchema: z.ZodType<Prisma.PriorityCreateNestedManyWithoutOrganizationInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.PriorityCreateNestedManyWithoutOrganizationInput>;

export default PriorityCreateNestedManyWithoutOrganizationInputSchema;
