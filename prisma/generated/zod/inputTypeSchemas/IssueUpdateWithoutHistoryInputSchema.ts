...
export const IssueUpdateWithoutHistoryInputSchema: z.ZodType<Prisma.IssueUpdateWithoutHistoryInput> =
  z
    .object({
      id: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.IssueUpdateWithoutHistoryInput>;
