...
export const NestedEnumStatusCategoryWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumStatusCategoryWithAggregatesFilter> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.NestedEnumStatusCategoryWithAggregatesFilter>;
