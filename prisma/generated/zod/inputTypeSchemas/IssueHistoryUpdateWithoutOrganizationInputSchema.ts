...
export const IssueHistoryUpdateWithoutOrganizationInputSchema: z.ZodType<Prisma.IssueHistoryUpdateWithoutOrganizationInput> =
  z
    .object({
      id: z
        .union([
      ...
      issue: z
        ...
        .optional(),
      actor: z
        .lazy(() => UserUpdateOneWithoutActivityHistoryNestedInputSchema)
        .optional(),
    })
    .strict() as z.ZodType<Prisma.IssueHistoryUpdateWithoutOrganizationInput>;

export default IssueHistoryUpdateWithoutOrganizationInputSchema;
