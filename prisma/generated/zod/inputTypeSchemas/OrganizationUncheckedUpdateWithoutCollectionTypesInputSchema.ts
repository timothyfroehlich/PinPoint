...
export const OrganizationUncheckedUpdateWithoutCollectionTypesInputSchema: z.ZodType<Prisma.OrganizationUncheckedUpdateWithoutCollectionTypesInput> = z.object({
  ...
  pinballMapConfig: z.lazy(() => PinballMapConfigUncheckedUpdateOneWithoutOrganizationNestedInputSchema).optional()
}).strict();

export default OrganizationUncheckedUpdateWithoutCollectionTypesInputSchema;
