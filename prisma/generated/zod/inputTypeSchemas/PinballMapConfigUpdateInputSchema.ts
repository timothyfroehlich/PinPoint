...
export const PinballMapConfigUpdateInputSchema: z.ZodType<Prisma.PinballMapConfigUpdateInput> =
  z
    .object({
      id: z
        .union([
      ...
      organization: z
        .lazy(
          () =>
            OrganizationUpdateOneRequiredWithoutPinballMapConfigNestedInputSchema,
        )
        .optional(),
    })
    .strict() as z.ZodType<Prisma.PinballMapConfigUpdateInput>;
