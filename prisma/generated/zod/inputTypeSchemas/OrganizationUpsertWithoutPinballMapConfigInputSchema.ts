...
export const OrganizationUpsertWithoutPinballMapConfigInputSchema: z.ZodType<Prisma.OrganizationUpsertWithoutPinballMapConfigInput> = z.object({
  update: z.union([ z.lazy(() => OrganizationUpdateWithoutPinballMapConfigInputSchema),z.lazy(() => OrganizationUncheckedUpdateWithoutPinballMapConfigInputSchema) ]),
  create: z.union([ z.lazy(() => OrganizationCreateWithoutPinballMapConfigInputSchema),z.lazy(() => OrganizationUncheckedCreateWithoutPinballMapConfigInputSchema) ]),
