...
export const LocationUpdateWithoutCollectionsInputSchema: z.ZodType<Prisma.LocationUpdateWithoutCollectionsInput> = z.object({
  ...
  organization: z.lazy(() => OrganizationUpdateOneRequiredWithoutLocationsNestedInputSchema).optional(),
  machines: z.lazy(() => MachineUpdateManyWithoutLocationNestedInputSchema).optional()
}).strict();

export default LocationUpdateWithoutCollectionsInputSchema;
