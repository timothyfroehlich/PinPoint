...
export const LocationCreateNestedOneWithoutCollectionsInputSchema: z.ZodType<Prisma.LocationCreateNestedOneWithoutCollectionsInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.LocationCreateNestedOneWithoutCollectionsInput>;
