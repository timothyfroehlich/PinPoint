...
export const IssueHistoryCreateWithoutIssueInputSchema: z.ZodType<Prisma.IssueHistoryCreateWithoutIssueInput> =
  z
    .object({
      ...
      organization: z.lazy(
        () => OrganizationCreateNestedOneWithoutIssueHistoryInputSchema,
      ),
      actor: z
        .lazy(() => UserCreateNestedOneWithoutActivityHistoryInputSchema)
        .optional(),
    })
    .strict() as z.ZodType<Prisma.IssueHistoryCreateWithoutIssueInput>;
