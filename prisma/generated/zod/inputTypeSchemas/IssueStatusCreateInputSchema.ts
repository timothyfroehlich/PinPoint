...
export const IssueStatusCreateInputSchema: z.ZodType<Prisma.IssueStatusCreateInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  category: z.lazy(() => StatusCategorySchema),
  isDefault: z.boolean().optional(),
  organization: z.lazy(() => OrganizationCreateNestedOneWithoutIssueStatusesInputSchema),
  issues: z.lazy(() => IssueCreateNestedManyWithoutStatusInputSchema).optional()
}).strict();
