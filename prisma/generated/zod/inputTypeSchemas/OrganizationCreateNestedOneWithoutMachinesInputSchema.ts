...
export const OrganizationCreateNestedOneWithoutMachinesInputSchema: z.ZodType<Prisma.OrganizationCreateNestedOneWithoutMachinesInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.OrganizationCreateNestedOneWithoutMachinesInput>;
