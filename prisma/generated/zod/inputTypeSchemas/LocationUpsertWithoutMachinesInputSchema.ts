...
export const LocationUpsertWithoutMachinesInputSchema: z.ZodType<Prisma.LocationUpsertWithoutMachinesInput> =
  z
    .object({
      update: z.union([
    ...
    .strict() as z.ZodType<Prisma.LocationUpsertWithoutMachinesInput>;
