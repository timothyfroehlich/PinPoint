...
export const CollectionUncheckedCreateWithoutLocationInputSchema: z.ZodType<Prisma.CollectionUncheckedCreateWithoutLocationInput> = z.object({
  ...
  machines: z.lazy(() => MachineUncheckedCreateNestedManyWithoutCollectionsInputSchema).optional()
}).strict();
