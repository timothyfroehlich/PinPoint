...
export const LocationUncheckedUpdateManyWithoutOrganizationNestedInputSchema: z.ZodType<Prisma.LocationUncheckedUpdateManyWithoutOrganizationNestedInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => LocationUncheckedCreateWithoutOrganizationInputSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => LocationCreateOrConnectWithoutOrganizationInputSchema)
            .array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(
            () => LocationUpsertWithWhereUniqueWithoutOrganizationInputSchema,
          ),
          z
            .lazy(
              () => LocationUpsertWithWhereUniqueWithoutOrganizationInputSchema,
        ...
        .optional(),
      createMany: z
        .lazy(() => LocationCreateManyOrganizationInputEnvelopeSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(
            () => LocationUpdateWithWhereUniqueWithoutOrganizationInputSchema,
          ),
          z
            .lazy(
              () => LocationUpdateWithWhereUniqueWithoutOrganizationInputSchema,
      ...
      updateMany: z
        .union([
          z.lazy(
            () => LocationUpdateManyWithWhereWithoutOrganizationInputSchema,
          ),
          z
            .lazy(
              () => LocationUpdateManyWithWhereWithoutOrganizationInputSchema,
    ...
    .strict() as z.ZodType<Prisma.LocationUncheckedUpdateManyWithoutOrganizationNestedInput>;

export default LocationUncheckedUpdateManyWithoutOrganizationNestedInputSchema;
