...
export const IssueUpsertWithWhereUniqueWithoutPriorityInputSchema: z.ZodType<Prisma.IssueUpsertWithWhereUniqueWithoutPriorityInput> = z.object({
  where: z.lazy(() => IssueWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => IssueUpdateWithoutPriorityInputSchema),z.lazy(() => IssueUncheckedUpdateWithoutPriorityInputSchema) ]),
  create: z.union([ z.lazy(() => IssueCreateWithoutPriorityInputSchema),z.lazy(() => IssueUncheckedCreateWithoutPriorityInputSchema) ]),
}).strict();
