...
export const UpvoteUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.UpvoteUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
          z.lazy(() => UpvoteCreateWithoutUserInputSchema),
          z.lazy(() => UpvoteCreateWithoutUserInputSchema).array(),
          z.lazy(() => UpvoteUncheckedCreateWithoutUserInputSchema),
          z.lazy(() => UpvoteUncheckedCreateWithoutUserInputSchema).array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          z.lazy(() => UpvoteCreateOrConnectWithoutUserInputSchema),
          z.lazy(() => UpvoteCreateOrConnectWithoutUserInputSchema).array(),
        ])
        .optional(),
      upsert: z
        .union([
          z.lazy(() => UpvoteUpsertWithWhereUniqueWithoutUserInputSchema),
          z
            .lazy(() => UpvoteUpsertWithWhereUniqueWithoutUserInputSchema)
            .array(),
        ])
        .optional(),
      createMany: z
        .lazy(() => UpvoteCreateManyUserInputEnvelopeSchema)
        .optional(),
      set: z
        .union([
      ...
      update: z
        .union([
          z.lazy(() => UpvoteUpdateWithWhereUniqueWithoutUserInputSchema),
          z
            .lazy(() => UpvoteUpdateWithWhereUniqueWithoutUserInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => UpvoteUpdateManyWithWhereWithoutUserInputSchema),
          z.lazy(() => UpvoteUpdateManyWithWhereWithoutUserInputSchema).array(),
        ])
        .optional(),
      deleteMany: z
        .union([
          z.lazy(() => UpvoteScalarWhereInputSchema),
          z.lazy(() => UpvoteScalarWhereInputSchema).array(),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.UpvoteUpdateManyWithoutUserNestedInput>;

export default UpvoteUpdateManyWithoutUserNestedInputSchema;
