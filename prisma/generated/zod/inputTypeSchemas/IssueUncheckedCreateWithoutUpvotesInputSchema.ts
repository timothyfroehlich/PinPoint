...
export const IssueUncheckedCreateWithoutUpvotesInputSchema: z.ZodType<Prisma.IssueUncheckedCreateWithoutUpvotesInput> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.IssueUncheckedCreateWithoutUpvotesInput>;
