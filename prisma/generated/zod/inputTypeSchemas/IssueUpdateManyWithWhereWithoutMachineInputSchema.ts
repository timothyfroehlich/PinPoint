...
export const IssueUpdateManyWithWhereWithoutMachineInputSchema: z.ZodType<Prisma.IssueUpdateManyWithWhereWithoutMachineInput> = z.object({
  where: z.lazy(() => IssueScalarWhereInputSchema),
  data: z.union([ z.lazy(() => IssueUpdateManyMutationInputSchema),z.lazy(() => IssueUncheckedUpdateManyWithoutMachineInputSchema) ]),
}).strict();
