...
export const IssueUpdateOneRequiredWithoutUpvotesNestedInputSchema: z.ZodType<Prisma.IssueUpdateOneRequiredWithoutUpvotesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => IssueUpdateToOneWithWhereWithoutUpvotesInputSchema),z.lazy(() => IssueUpdateWithoutUpvotesInputSchema),z.lazy(() => IssueUncheckedUpdateWithoutUpvotesInputSchema) ]).optional(),
}).strict();
