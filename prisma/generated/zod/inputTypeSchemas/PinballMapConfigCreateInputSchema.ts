...
export const PinballMapConfigCreateInputSchema: z.ZodType<Prisma.PinballMapConfigCreateInput> = z.object({
  ...
  organization: z.lazy(() => OrganizationCreateNestedOneWithoutPinballMapConfigInputSchema)
}).strict();
