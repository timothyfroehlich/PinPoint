...
export const CollectionCreateWithoutMachinesInputSchema: z.ZodType<Prisma.CollectionCreateWithoutMachinesInput> =
  z
    .object({
      ...
      location: z
        .lazy(() => LocationCreateNestedOneWithoutCollectionsInputSchema)
        .optional(),
    })
    .strict() as z.ZodType<Prisma.CollectionCreateWithoutMachinesInput>;
