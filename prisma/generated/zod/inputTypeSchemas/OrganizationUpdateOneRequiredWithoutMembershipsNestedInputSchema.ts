  ...
  z
    .object({
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => OrganizationUpsertWithoutMembershipsInputSchema)
        .optional(),
      connect: z.lazy(() => OrganizationWhereUniqueInputSchema).optional(),
      update: z
        .union([
          z.lazy(
            () => OrganizationUpdateToOneWithWhereWithoutMembershipsInputSchema,
          ),
          z.lazy(() => OrganizationUpdateWithoutMembershipsInputSchema),
          z.lazy(
            () => OrganizationUncheckedUpdateWithoutMembershipsInputSchema,
          ),
        ])
        .optional(),
    })
    .strict() as z.ZodType<Prisma.OrganizationUpdateOneRequiredWithoutMembershipsNestedInput>;
