...
export const IssueUpdateManyWithWhereWithoutPriorityInputSchema: z.ZodType<Prisma.IssueUpdateManyWithWhereWithoutPriorityInput> =
  z
    .object({
      where: z.lazy(() => IssueScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => IssueUpdateManyMutationInputSchema),
        z.lazy(() => IssueUncheckedUpdateManyWithoutPriorityInputSchema),
      ]),
    })
    .strict() as z.ZodType<Prisma.IssueUpdateManyWithWhereWithoutPriorityInput>;
