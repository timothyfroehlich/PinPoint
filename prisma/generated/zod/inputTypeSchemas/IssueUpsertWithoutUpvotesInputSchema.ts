...
export const IssueUpsertWithoutUpvotesInputSchema: z.ZodType<Prisma.IssueUpsertWithoutUpvotesInput> =
  z
    .object({
      update: z.union([
    ...
    .strict() as z.ZodType<Prisma.IssueUpsertWithoutUpvotesInput>;
