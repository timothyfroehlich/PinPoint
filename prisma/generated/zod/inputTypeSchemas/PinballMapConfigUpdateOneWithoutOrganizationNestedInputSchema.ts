...
export const PinballMapConfigUpdateOneWithoutOrganizationNestedInputSchema: z.ZodType<Prisma.PinballMapConfigUpdateOneWithoutOrganizationNestedInput> = z.object({
  ...
  upsert: z.lazy(() => PinballMapConfigUpsertWithoutOrganizationInputSchema).optional(),
  disconnect: z.union([ z.boolean(),z.lazy(() => PinballMapConfigWhereInputSchema) ]).optional(),
  delete: z.union([ z.boolean(),z.lazy(() => PinballMapConfigWhereInputSchema) ]).optional(),
  connect: z.lazy(() => PinballMapConfigWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => PinballMapConfigUpdateToOneWithWhereWithoutOrganizationInputSchema),z.lazy(() => PinballMapConfigUpdateWithoutOrganizationInputSchema),z.lazy(() => PinballMapConfigUncheckedUpdateWithoutOrganizationInputSchema) ]).optional(),
}).strict();

export default PinballMapConfigUpdateOneWithoutOrganizationNestedInputSchema;
