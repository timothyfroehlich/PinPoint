...
export const IssueUpdateManyWithWhereWithoutStatusInputSchema: z.ZodType<Prisma.IssueUpdateManyWithWhereWithoutStatusInput> = z.object({
  where: z.lazy(() => IssueScalarWhereInputSchema),
  data: z.union([ z.lazy(() => IssueUpdateManyMutationInputSchema),z.lazy(() => IssueUncheckedUpdateManyWithoutStatusInputSchema) ]),
}).strict();
