...
export const UserUpsertWithoutDeletedCommentsInputSchema: z.ZodType<Prisma.UserUpsertWithoutDeletedCommentsInput> = z.object({
  update: z.union([ z.lazy(() => UserUpdateWithoutDeletedCommentsInputSchema),z.lazy(() => UserUncheckedUpdateWithoutDeletedCommentsInputSchema) ]),
