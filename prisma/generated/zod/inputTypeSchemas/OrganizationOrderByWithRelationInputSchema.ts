...
export const OrganizationOrderByWithRelationInputSchema: z.ZodType<Prisma.OrganizationOrderByWithRelationInput> =
  z
    .object({
      ...
      priorities: z
        .lazy(() => PriorityOrderByRelationAggregateInputSchema)
        .optional(),
      issueStatuses: z
        .lazy(() => IssueStatusOrderByRelationAggregateInputSchema)
        .optional(),
      collectionTypes: z
        .lazy(() => CollectionTypeOrderByRelationAggregateInputSchema)
        .optional(),
      issueHistory: z
      ...
      attachments: z
        ...
        .optional(),
      pinballMapConfig: z
        .lazy(() => PinballMapConfigOrderByWithRelationInputSchema)
        .optional(),
    })
    .strict() as z.ZodType<Prisma.OrganizationOrderByWithRelationInput>;
