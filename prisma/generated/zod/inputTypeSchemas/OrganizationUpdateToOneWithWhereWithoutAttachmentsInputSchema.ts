...
export const OrganizationUpdateToOneWithWhereWithoutAttachmentsInputSchema: z.ZodType<Prisma.OrganizationUpdateToOneWithWhereWithoutAttachmentsInput> = z.object({
  where: z.lazy(() => OrganizationWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => OrganizationUpdateWithoutAttachmentsInputSchema),z.lazy(() => OrganizationUncheckedUpdateWithoutAttachmentsInputSchema) ]),
}).strict();
