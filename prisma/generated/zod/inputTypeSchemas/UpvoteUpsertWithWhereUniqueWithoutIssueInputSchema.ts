...
export const UpvoteUpsertWithWhereUniqueWithoutIssueInputSchema: z.ZodType<Prisma.UpvoteUpsertWithWhereUniqueWithoutIssueInput> = z.object({
  where: z.lazy(() => UpvoteWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => UpvoteUpdateWithoutIssueInputSchema),z.lazy(() => UpvoteUncheckedUpdateWithoutIssueInputSchema) ]),
