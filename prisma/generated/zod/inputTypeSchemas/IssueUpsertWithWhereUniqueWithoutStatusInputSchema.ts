...
export const IssueUpsertWithWhereUniqueWithoutStatusInputSchema: z.ZodType<Prisma.IssueUpsertWithWhereUniqueWithoutStatusInput> = z.object({
  where: z.lazy(() => IssueWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => IssueUpdateWithoutStatusInputSchema),z.lazy(() => IssueUncheckedUpdateWithoutStatusInputSchema) ]),
