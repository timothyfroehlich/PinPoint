...
export const IssueStatusUncheckedUpdateWithoutOrganizationInputSchema: z.ZodType<Prisma.IssueStatusUncheckedUpdateWithoutOrganizationInput> =
  z
    .object({
      id: z
        .union([
      ...
      isDefault: z
        ...
        .optional(),
      issues: z
        .lazy(() => IssueUncheckedUpdateManyWithoutStatusNestedInputSchema)
        .optional(),
    })
    .strict() as z.ZodType<Prisma.IssueStatusUncheckedUpdateWithoutOrganizationInput>;
