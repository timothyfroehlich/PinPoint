...
export const CollectionCreateWithoutTypeInputSchema: z.ZodType<Prisma.CollectionCreateWithoutTypeInput> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.CollectionCreateWithoutTypeInput>;
