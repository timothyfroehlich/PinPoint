...
export const MachineCreateWithoutIssuesInputSchema: z.ZodType<Prisma.MachineCreateWithoutIssuesInput> =
  z
    .object({
    ...
    .strict() as z.ZodType<Prisma.MachineCreateWithoutIssuesInput>;
