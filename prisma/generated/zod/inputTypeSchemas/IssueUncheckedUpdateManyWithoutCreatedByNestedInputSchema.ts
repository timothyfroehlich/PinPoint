...
export const IssueUncheckedUpdateManyWithoutCreatedByNestedInputSchema: z.ZodType<Prisma.IssueUncheckedUpdateManyWithoutCreatedByNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => IssueUpsertWithWhereUniqueWithoutCreatedByInputSchema),z.lazy(() => IssueUpsertWithWhereUniqueWithoutCreatedByInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => IssueUpdateWithWhereUniqueWithoutCreatedByInputSchema),z.lazy(() => IssueUpdateWithWhereUniqueWithoutCreatedByInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => IssueUpdateManyWithWhereWithoutCreatedByInputSchema),z.lazy(() => IssueUpdateManyWithWhereWithoutCreatedByInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => IssueScalarWhereInputSchema),z.lazy(() => IssueScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default IssueUncheckedUpdateManyWithoutCreatedByNestedInputSchema;
