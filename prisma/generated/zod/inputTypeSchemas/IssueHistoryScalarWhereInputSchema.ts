...
export const IssueHistoryScalarWhereInputSchema: z.ZodType<Prisma.IssueHistoryScalarWhereInput> =
  z
    .object({
      AND: z
        .union([
        ...
        .optional(),
      OR: z
        .lazy(() => IssueHistoryScalarWhereInputSchema)
        .array()
        .optional(),
      NOT: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.IssueHistoryScalarWhereInput>;
