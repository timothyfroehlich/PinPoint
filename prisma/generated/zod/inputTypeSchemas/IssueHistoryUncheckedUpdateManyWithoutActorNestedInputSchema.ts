...
export const IssueHistoryUncheckedUpdateManyWithoutActorNestedInputSchema: z.ZodType<Prisma.IssueHistoryUncheckedUpdateManyWithoutActorNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => IssueHistoryUpsertWithWhereUniqueWithoutActorInputSchema,
          ),
          z
            .lazy(
              () => IssueHistoryUpsertWithWhereUniqueWithoutActorInputSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => IssueHistoryUpdateWithWhereUniqueWithoutActorInputSchema,
          ),
          z
            .lazy(
              () => IssueHistoryUpdateWithWhereUniqueWithoutActorInputSchema,
      ...
      updateMany: z
        .union([
          z.lazy(() => IssueHistoryUpdateManyWithWhereWithoutActorInputSchema),
          z
            .lazy(() => IssueHistoryUpdateManyWithWhereWithoutActorInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
    ...
    .strict() as z.ZodType<Prisma.IssueHistoryUncheckedUpdateManyWithoutActorNestedInput>;

export default IssueHistoryUncheckedUpdateManyWithoutActorNestedInputSchema;
