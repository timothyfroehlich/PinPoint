...
export const IssueStatusUpdateManyWithWhereWithoutOrganizationInputSchema: z.ZodType<Prisma.IssueStatusUpdateManyWithWhereWithoutOrganizationInput> =
  z
    .object({
      where: z.lazy(() => IssueStatusScalarWhereInputSchema),
      data: z.union([
        z.lazy(() => IssueStatusUpdateManyMutationInputSchema),
        z.lazy(
          () => IssueStatusUncheckedUpdateManyWithoutOrganizationInputSchema,
        ),
      ]),
    })
    .strict() as z.ZodType<Prisma.IssueStatusUpdateManyWithWhereWithoutOrganizationInput>;
