...
export const IssueUpdateWithWhereUniqueWithoutAssignedToInputSchema: z.ZodType<Prisma.IssueUpdateWithWhereUniqueWithoutAssignedToInput> = z.object({
  where: z.lazy(() => IssueWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => IssueUpdateWithoutAssignedToInputSchema),z.lazy(() => IssueUncheckedUpdateWithoutAssignedToInputSchema) ]),
}).strict();
