...
export const PinballMapConfigCreateNestedOneWithoutOrganizationInputSchema: z.ZodType<Prisma.PinballMapConfigCreateNestedOneWithoutOrganizationInput> =
  z
    .object({
      create: z
        .union([
    ...
    .strict() as z.ZodType<Prisma.PinballMapConfigCreateNestedOneWithoutOrganizationInput>;
