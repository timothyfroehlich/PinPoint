...
export const IssueUpdateToOneWithWhereWithoutUpvotesInputSchema: z.ZodType<Prisma.IssueUpdateToOneWithWhereWithoutUpvotesInput> = z.object({
  where: z.lazy(() => IssueWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => IssueUpdateWithoutUpvotesInputSchema),z.lazy(() => IssueUncheckedUpdateWithoutUpvotesInputSchema) ]),
}).strict();
