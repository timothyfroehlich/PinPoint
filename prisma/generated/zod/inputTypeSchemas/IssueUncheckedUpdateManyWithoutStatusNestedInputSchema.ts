...
export const IssueUncheckedUpdateManyWithoutStatusNestedInputSchema: z.ZodType<Prisma.IssueUncheckedUpdateManyWithoutStatusNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(() => IssueUpsertWithWhereUniqueWithoutStatusInputSchema),
          z
            .lazy(() => IssueUpsertWithWhereUniqueWithoutStatusInputSchema)
            .array(),
        ])
        .optional(),
      createMany: z
      ...
      update: z
        .union([
          z.lazy(() => IssueUpdateWithWhereUniqueWithoutStatusInputSchema),
          z
            .lazy(() => IssueUpdateWithWhereUniqueWithoutStatusInputSchema)
            .array(),
        ])
        .optional(),
      updateMany: z
        .union([
          z.lazy(() => IssueUpdateManyWithWhereWithoutStatusInputSchema),
          z
            .lazy(() => IssueUpdateManyWithWhereWithoutStatusInputSchema)
            .array(),
        ])
        .optional(),
      deleteMany: z
    ...
    .strict() as z.ZodType<Prisma.IssueUncheckedUpdateManyWithoutStatusNestedInput>;

export default IssueUncheckedUpdateManyWithoutStatusNestedInputSchema;
