  ...
  if (userIds.admin) {
    ...
    const issueSeed = [
      ...
      },
      {
        ...
        initials: "HD",
        num: 2,
        title: "Scoring reels occasionally sticking during active gameplay requiring a step-up unit contact cleaning",
        desc: "Testing maximum title length (100 characters). The scoring reels occasionally stick when incrementing, requiring manual adjustment.",
        status: "in_progress",
        severity: "major",
        priority: "medium",
