...
CREATE TABLE "issues" (
	...
	"anonymous_contact_method" varchar,
...
CREATE POLICY "organizations_member_modify" ON "organizations" AS PERMISSIVE FOR ALL TO "authenticated" USING (((id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
   FROM memberships m
  WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true))))))) WITH CHECK (((id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
   FROM memberships m
...
CREATE POLICY "organizations_public_read" ON "organizations" AS PERMISSIVE FOR SELECT TO "anon";--> statement-breakpoint
CREATE POLICY "users_no_anon_access" ON "users" AS PERMISSIVE FOR ALL TO "anon" USING (false);--> statement-breakpoint
CREATE POLICY "users_self_access" ON "users" AS PERMISSIVE FOR ALL TO "authenticated";--> statement-breakpoint
CREATE POLICY "memberships_org_member_read" ON "memberships" AS PERMISSIVE FOR SELECT TO "authenticated" USING (((organization_id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
   FROM memberships m
  WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true)))))));--> statement-breakpoint
CREATE POLICY "memberships_self_access" ON "memberships" AS PERMISSIVE FOR ALL TO "authenticated";--> statement-breakpoint
CREATE POLICY "roles_member_access" ON "roles" AS PERMISSIVE FOR ALL TO "authenticated" USING (((organization_id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
  ...
  WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true))))))) WITH CHECK (((organization_id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
   FROM memberships m
  WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true)))))));--> statement-breakpoint
CREATE POLICY "locations_member_modify" ON "locations" AS PERMISSIVE FOR ALL TO "authenticated" USING (((organization_id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
   FROM memberships m
  WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true))))))) WITH CHECK (((organization_id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
   FROM memberships m
  WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true)))))));--> statement-breakpoint
CREATE POLICY "locations_public_read" ON "locations" AS PERMISSIVE FOR SELECT TO "anon", "authenticated";--> statement-breakpoint
CREATE POLICY "machines_member_all_access" ON "machines" AS PERMISSIVE FOR ALL TO "authenticated" USING (((organization_id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
   FROM memberships m
  WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true))))))) WITH CHECK (((organization_id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
   FROM memberships m
  WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true)))))));--> statement-breakpoint
CREATE POLICY "machines_public_read" ON "machines" AS PERMISSIVE FOR SELECT TO "anon", "authenticated";--> statement-breakpoint
CREATE POLICY "issues_member_access" ON "issues" AS PERMISSIVE FOR ALL TO "authenticated" USING (((organization_id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
   FROM memberships m
  WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true))))))) WITH CHECK (((organization_id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
   FROM memberships m
  WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true)))))));--> statement-breakpoint
CREATE POLICY "issues_public_read" ON "issues" AS PERMISSIVE FOR SELECT TO "anon", "authenticated";--> statement-breakpoint
CREATE POLICY "issues_anon_create" ON "issues" AS PERMISSIVE FOR INSERT TO "anon";--> statement-breakpoint
...
CREATE POLICY "issue_statuses_member_access" ON "issue_statuses" AS PERMISSIVE FOR ALL TO "authenticated" USING (((organization_id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
  ...
  WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true))))))) WITH CHECK (((organization_id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
   FROM memberships m
  WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true)))))));--> statement-breakpoint
CREATE POLICY "comments_member_access" ON "comments" AS PERMISSIVE FOR ALL TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM issues i
  WHERE ((i.id = comments.issue_id) AND (i.organization_id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
           FROM memberships m
          WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true))))))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM issues i
  WHERE ((i.id = comments.issue_id) AND (i.organization_id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
           FROM memberships m
          WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true)))))))));--> statement-breakpoint
CREATE POLICY "comments_anon_create_public" ON "comments" AS PERMISSIVE FOR INSERT TO "anon";--> statement-breakpoint
...
CREATE POLICY "pinball_map_configs_member_access" ON "pinball_map_configs" AS PERMISSIVE FOR ALL TO "authenticated" USING (((organization_id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
  ...
  WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true))))))) WITH CHECK (((organization_id = current_setting('app.current_organization_id'::text, true)) AND (EXISTS ( SELECT 1
   FROM memberships m
  WHERE ((m.user_id = (auth.uid())::text) AND (m.organization_id = current_setting('app.current_organization_id'::text, true)))))));--> statement-breakpoint
CREATE POLICY "anonymous_rate_limits_system_insert" ON "anonymous_rate_limits" AS PERMISSIVE FOR INSERT TO "anon" WITH CHECK ((organization_id = current_setting('app.current_organization_id'::text, true)));--> statement-breakpoint
CREATE POLICY "anonymous_rate_limits_member_access" ON "anonymous_rate_limits" AS PERMISSIVE FOR ALL TO "authenticated";
*/