...
test.describe("Authentication Flow", () => {
  ...
  test("should load the homepage when not authenticated", async ({ page }) => {
    ...
    await expect(page.locator('button', { hasText: "Test Admin" })).toBeVisible();
    await expect(page.locator('button', { hasText: "Test Member" })).toBeVisible();
    await expect(page.locator('button', { hasText: "Test Player" })).toBeVisible();
  ...
  test("should authenticate as admin and access dashboard", async ({ page }) => {
  ...
  test("should authenticate as member with standard permissions", async ({ page }) => {
  ...
  test("should authenticate as player with limited permissions", async ({ page }) => {
